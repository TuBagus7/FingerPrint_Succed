...
(function () {
            ...
            if (f) {
              ...
              if (w.length)
                for (var w = w.slice(0), A, E = 0; E < w.length; E++) {
                  if (f.errorProof)
                    try {
                      A = w[E].call(this, q, n, b, h);
                    } catch (x) {}
                  else A = w[E].call(this, q, n, b, h);
  ...
  (function () {
            ...
            ? f.type == CKEDITOR.NODE_ELEMENT &&
              (f =
                0 < C
                  ...
                  : !1 === g(f, !0)
                  ? null
                  : f.getPreviousSourceNode(!0, u, g))
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f =
                    !1 === g(d, !0) ? null : d.getNextSourceNode(!0, u, g)))),
          f && !1 === g(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
    ...
    var f = CKEDITOR.dom.walker.empty(),
      C = (CKEDITOR.dom.walker.validEmptyBlockContainers =
        CKEDITOR.tools.extend(
          (function (a) {
            var b = {},
              c;
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
            (b.type == CKEDITOR.NODE_ELEMENT &&
              (b.is(CKEDITOR.dtd.$inline) ||
                ...
                (!CKEDITOR.env.needsBrFiller && b.is(C) && f(b))))
          ? !0
          : !1;
        return !!(a ^ b);
      };
  ...
  (function () {
    ...
    function d(a, b, c, d, e) {
      ...
      function h() {
        ...
        b < t - 1 || b < G - 1 || c
          ? (c
              ? a.moveToPosition(I, CKEDITOR.POSITION_BEFORE_START)
              : G == b + 1 && z
      ...
      var u = a.startContainer,
        ...
        L,
        n;
      if (l && I.type == CKEDITOR.NODE_TEXT && u.equals(I))
        (u = a.document.createText(u.substring(J, D))), c.append(u);
      else {
        ...
        for (
          ...
          U = X.getNext();
          for (
            P != t || (X.equals(p[P]) && t < G)
              ? b && (Z = N.append(X.clone(0, e)))
              : r
              ? g(X, N, !1, v)
              : L && N.append(a.document.createText(X.substring(J)));
            U;
        ...
        for (P = F; P <= G; P++)
          if (((c = p[P]), (U = c.getPrevious()), c.equals(O[P])))
            ...
            P != G || (c.equals(O[P]) && G < t)
              ? b && (Z = N.append(c.clone(0, e)))
              : z
              ? g(c, N, !1, B)
              : n && N.append(a.document.createText(c.substring(0, D)));
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            D.type == CKEDITOR.NODE_TEXT
              ? (z &&
                  ((D = !CKEDITOR.tools.trim(D.substring(0, z)).length && D),
                  (J = !!D)),
                D && ((u = D.getPrevious()) || (l = D.getParent())))
              : (z && (u = D.getChild(z - 1) || D.getLast()), u || (l = D));
            for (l = c(l); l || u; ) {
              if (l && !u) {
                !I && l.equals(m) && (I = !0);
                if (e ? l.isBlockBoundary() : !h.contains(l)) break;
                (J && "inline" == l.getComputedStyle("display")) ||
                  ((J = !1), I ? (k = l) : this.setStartBefore(l));
                u = l.getPrevious();
              }
              for (; u; )
                if (((D = !1), u.type == CKEDITOR.NODE_COMMENT))
                  u = u.getPrevious();
                else {
                  if (u.type == CKEDITOR.NODE_TEXT)
                    ...
                    if (J && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                      ...
                      if (d.test(r)) u = null;
                        ...
                        for (
                          var z = u.$.getElementsByTagName("*"), v = 0, B;
                          (B = z[v++]);
            ...
            I = J = !1;
            D.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(D.substring(z)).length
                ? (J = !0)
                : ((J = !D.getLength()),
                  z == D.getLength()
                    ? (u = D.getNext()) || (l = D.getParent())
                    : g(D, z) && (l = D.getParent()))
              : (u = D.getChild(z)) || (l = D);
            for (; l || u; ) {
              if (l && !u) {
                ...
                if (e ? l.isBlockBoundary() : !h.contains(l)) break;
                (J && "inline" == l.getComputedStyle("display")) ||
                  ((J = !1), I ? (q = l) : l && this.setEndAfter(l));
                u = l.getNext();
              }
              for (; u; ) {
                D = !1;
  ...
  (function () {
    function a(a, b, c, d, e) {
      ...
      for (l in b) {
        ...
        for (g in V) {
          ...
          for (F in G)
            "!" == F.charAt(0) &&
              ((F = F.slice(1)), z.push(F), (m[F] = !0), (B = !1));
          for (; (F = z.pop()); ) (G[F] = G["!" + F]), delete G["!" + F];
          p[u] = (B ? !1 : m) || null;
        }
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var l = 0, t = c.length, f; l < t; ++l)
                  (f = c[l]), e[f] || (e[f] = a(f));
                a = !1;
              }
            else a = !1;
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        b = b.classes;
        if (a) {
          for (var d = !1, l = !0 === a, f = b.length; f--; )
            if (l || a(b[f])) b.splice(f, 1), (d = !0);
          a = d;
        } else a = !1;
    ...
    function f(a) {
      ...
      for (a = B(a); (b = a.match(p)); )
        (c = b[2])
          ? ((d = C(c, "styles")), (e = C(c, "attrs")), (c = C(c, "classes")))
          : (d = e = c = null),
          (l["$" + f++] = {
            elements: b[1],
            classes: c,
      ...
      if (l.doFilter) {
        a: {
          ...
          if (a || r) {
            ...
            if (g) for (h = 0, B = g.length; h < B; ++h) c(g[h], b, z);
            if (a) for (h = 0, B = a.length; h < B; ++h) d(a[h], b, z, p);
            if (r) for (h = 0, B = r.length; h < B; ++h) d(r[h], b, z, p);
            a = z;
          } else a = null;
        }
    ...
    function H(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || z.$block[a.name])
      );
    }
    function l(a, b, c) {
      var d = a.name;
      if (z.$empty[d] || !a.children.length)
        ...
        if ("br" == b)
          a.previous && !H(a.previous) && ((b = y()), b.insertBefore(a)),
            a.next && !H(a.next) && ((b = y()), b.insertAfter(a)),
          ...
          b: {
            e = z[b];
            for (var l = 0, f = d.length, t; l < f; ++l)
              if (((t = d[l]), t.type == CKEDITOR.NODE_ELEMENT && !e[t.name])) {
                e = !1;
                break b;
              }
            e = !0;
            ...
            for (
              ...
              (t = d[--f]),
                ...
                (t.type == CKEDITOR.NODE_TEXT ||
                  (t.type == CKEDITOR.NODE_ELEMENT && z.$inline[t.name]))
                  ? (v ||
    ...
    function I(a, b) {
      ...
      for (l in d)
        if ("class" == l)
          for (
            c = d[l].split(/\s+/), t = a.classes.join("|");
            (v = c.pop());
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, c, d) {
        ...
        for (; (p = a.pop()); )
          if (((c = p.el), c.parent))
            switch (((u = z[c.parent.name] || z.span), p.check)) {
              case "it":
                z.$removeEmpty[c.name] && !c.children.length
                  ? l(c, d, a)
                  : m(c) || l(c, d, a);
                break;
              case "el-up":
          ...
          for (e = 0; e < a.length; ++e) {
            ...
            for (f = 0; f < b.length; ++f)
              (t = b[f]),
                ...
                g instanceof CKEDITOR.style && (g = D(g)),
                c.push({
                  check: v == l ? null : v,
                  left: g,
                  right: "string" == typeof p ? r(p) : p,
                });
            b = l;
            d[b] || (d[b] = []);
            d[b].push(c);
      ...
      check: function (a, b, c) {
        ...
        if (!1 !== b && (g = this._.transformations[e.name])) {
          for (d = 0; d < g.length; ++d) u(this, e, g[d]);
          x(e);
        }
        A(this, t, r, {
          doFilter: !0,
            ...
            a.call(
              ...
              function (a) {
                ...
                for (f in a) {
                  ...
                  if (!d[f]) {
                    if (k.icons)
                      for (var A = k.icons.split(","), E = A.length; E--; )
  ...
  (function () {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var l in c) {
          ...
          h &&
            !a.lang[l] &&
            (h.split && (h = h.split(",")),
            0 <= CKEDITOR.tools.indexOf(h, a.langCode)
              ? (k = a.langCode)
              : ((k = a.langCode.replace(/-.*/, "")),
                (k =
                  k != a.langCode && 0 <= CKEDITOR.tools.indexOf(h, k)
                    ? k
                    : 0 <= CKEDITOR.tools.indexOf(h, "en")
                    ? "en"
                    : h[0])),
            u.langEntries && u.langEntries[k]
              ? ((a.lang[l] = u.langEntries[k]), (k = null))
              : f.push(CKEDITOR.getUrl(u.path + "lang/" + k + ".js")));
          e.push(k);
          d.push(u);
        }
        CKEDITOR.scriptLoader.load(f, function () {
          for (
            var c = ["beforeInit", "init", "afterInit"], l = 0;
            l < c.length;
            l++
          )
            for (var f = 0; f < d.length; f++) {
              ...
              0 === l &&
                ...
                v.lang &&
                v.langEntries &&
                (a.lang[v.name] = v.langEntries[e[f]]);
              if (v[c[l]]) v[c[l]](a);
            }
    ...
    function A(a, b) {
      ...
      for (
        ...
        c(r)
          ? (f ||
              ((f = z.getAscendant("table").clone()),
              f.append(
                z.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()
              ),
              e.append(f),
              (f = f.findOne("thead, tbody, tfoot"))),
            (g && g.equals(z)) || ((g = z), (h = z.clone()), f.append(h)),
            h.append(d(r)))
          : e.append(r.cloneContents());
      }
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (g, h, k) {
      ...
      function C(b, c, d) {
        ...
        var e = y;
        void 0 === b.previous &&
          (w(c, b) && ((y = c), E.onTagOpen(k, {}), (b.returnPoint = c = y)),
          f(b),
      ...
      E.onText = function (a) {
        if (
          !((y._.hasInlineStarted && !K.length) || l || H) &&
  ...
  (function () {
        ...
        return function (e) {
          if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var l = [],
              ...
              p;
            if (t)
              for (r(t, 1) && l.push(t); t; )
                g(t) &&
                  (v = c(t)) &&
                  r(v) &&
                  ((p = c(v)) && !g(p)
                    ? l.push(v)
                    : (f(z).insertAfter(v), v.remove())),
                  (t = t.previous);
      ...
      function r(a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          ...
          (c.index &&
            ...
            (a.value = c[0])),
          (!CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in B)) ||
    ...
    function x(a, b) {
      ...
      return (a = a.replace(
        ...
        function (a, c, d, e) {
          return "\x3c" + c + d + "\x3e" + E(A(e), b) + "\x3c/" + c + "\x3e";
        }
      ));
    }
    ...
    var m = /(?:&nbsp;|\xa0)$/,
      ...
      l = CKEDITOR.tools.extend({}, y.$blockLimit, y.$block),
        ...
        elements: {
          ...
          table: function (a) {
            a.children.slice(0).sort(function (a, b) {
              ...
              a.type == CKEDITOR.NODE_ELEMENT &&
                b.type == a.type &&
                ((c = CKEDITOR.tools.indexOf(H, a.name)),
                (d = CKEDITOR.tools.indexOf(H, b.name)));
              (-1 < c && -1 < d && c != d) ||
  ...
  (function () {
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (c in z) {
                ...
                (e = g(b))
                  ...
                  : r.collapsed &&
                    ((h = p.block) &&
                    (k = h[c ? "getPrevious" : "getNext"](f)) &&
                    k.type == CKEDITOR.NODE_ELEMENT &&
                    k.is("table") &&
                    r[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                      ? (a.fire("saveSnapshot"),
                        r[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                          h.remove(),
                        r["moveToElementEdit" + (c ? "End" : "Start")](k),
                        r.select(),
                        a.fire("saveSnapshot"),
                        (d = 1))
                      : p.blockLimit &&
                      ...
                      ? (a.fire("saveSnapshot"),
                        r["moveToElementEdit" + (c ? "End" : "Start")](k),
                        r.checkStartOfBlock() && r.checkEndOfBlock()
                          ? k.remove()
                          : r.select(),
                        a.fire("saveSnapshot"),
                        (d = 1))
            ...
            CKEDITOR.env.gecko &&
              this.attachListener(this, "mouseup", function (b) {
                if (
                  2 == b.data.$.button &&
                  ((b = b.data.getTarget()), !b.getOuterHtml().replace(E, ""))
                ) {
                  var c = a.createRange();
    ...
    x = (function () {
      ...
      function d(b, c) {
        ...
        for (k && e.push(" "); h < r; h++)
          (g = f.getItem(h)),
            a(g) && !g.is(z) ? (e = e.concat(d(g, c))) : e.push(g);
        k && e.push(" ");
        return e;
      }
      function e(b) {
      ...
      return function (B, p, F, t) {
        ...
        if (!t.checkReadOnly()) {
          ...
          for (G = m.startNode; (G = G.getParent()) && f(G); ) t.push(G);
          p.moveToBookmark(m);
          if ((m = F)) {
            m = B.range;
            ...
            F = B.editor.dataProcessor.toHtml(F, {
              context: null,
              fixForBody: !1,
          ...
          if (m) {
                ...
                q.hasBlockSibling
                  ...
                  ? ((Y = R.getPosition(H)),
                    ...
                    Y == CKEDITOR.POSITION_CONTAINS
                      ? (M = 0)
                      : ((H = M.splitElement(R)),
                        M.moveToPosition(H, CKEDITOR.POSITION_AFTER_START),
                        (M = 1)))
                  : (M = 0);
              }
              if (M) F = 0 < t;
            ...
            1 != p.length
              ...
              : ((y = p[0]),
                (y =
                  y.isElement &&
                  "false" == y.node.getAttribute("contenteditable")));
            y &&
              ((F = !0),
              (M = p[0].node),
          ...
          for (W = y.createBookmark(); (E = B.zombies.pop()); )
            E.getParent() &&
              ((S = y.clone()),
              S.moveToElementEditStart(E),
              S.removeEmptyBlocksAtEnd());
          if (K)
            for (; (E = K.pop()); )
              CKEDITOR.env.needsBrFiller
                ? E.appendBogus()
                : E.append(y.document.createText(" "));
          for (; (E = B.mergeCandidates.pop()); ) E.mergeSiblings();
          y.moveToBookmark(W);
          if (!B.dontMoveCaret) {
            for (E = e(y); E && a(E) && !E.is(v.$empty); ) {
              if (E.isBlockBoundary())
                y.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
              else {
              ...
              if (p || l)
                p && l && b(p, l)
                  ? ((e.tableSurroundingRange = h),
                    h.setStartAt(p, CKEDITOR.POSITION_AFTER_END),
                    h.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                    (h = g.clone()),
                    h.setEndAt(p, CKEDITOR.POSITION_AFTER_END),
                    (k = g.clone()),
  ...
  (function () {
    ...
    var x = "function" != typeof window.getSelection,
      ...
      l,
      u,
      I = CKEDITOR.dom.walker.invisible(1),
      J = (function () {
        function a(b) {
          return function (a) {
      ...
      c.on("contentDom", function () {
        ...
        function b() {
          ...
          var a = CKEDITOR.document.$.selection,
            c = a.createRange();
          "None" != a.type &&
            c.parentElement().ownerDocument == h.$ &&
            c.select();
        }
        function d(a) {
          if (CKEDITOR.env.ie) {
        ...
        k.attachListener(
          ...
          function () {
            z &&
              ...
              c._.previousScrollTop != k.$.scrollTop &&
        ...
        if (r && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          ...
          k.attachListener(h.getDocumentElement(), "mouseup", function () {
            u && g.call(c);
            u = 0;
          });
        } else
          k.attachListener(
            CKEDITOR.env.ie ? k : h.getDocumentElement(),
            "mouseup",
            g,
            c
          );
    ...
    if (CKEDITOR.env.webkit)
      CKEDITOR.on("instanceReady", function (a) {
        ...
        b.on(
          "toDataFormat",
          function (a) {
            a.data.dataValue = C(a.data.dataValue);
          },
          null,
          null,
          0
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
      _removeFillingCharSequenceString: C,
        ...
        : function () {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              d == c.endContainer &&
                ...
                D[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
        ...
        var a = x
          ? (function () {
              ...
              var b = function (b, c) {
                ...
                return {
                  container: m,
                  offset: 0 < q ? -h : m.nodeValue.length + h,
                };
              };
              return function () {
              ...
              if (x) {
                ...
                if (
                  (d.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    d.startContainer.getName() in F) ||
                  (d.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                    d.endContainer.getName() in F)
                )
                ...
                k
                  ...
                  : ((t = F.getNext(p)),
                    (G = F.hasAscendant("pre")),
                    (t =
                      !(t && t.getText && t.getText().match(l)) &&
                      (G ||
                        !F.hasPrevious() ||
                        (F.getPrevious().is && F.getPrevious().is("br")))),
                    (G = d.document.createElement("span")),
                    G.setHtml("\x26#65279;"),
                    G.insertBefore(F),
                    t && d.document.createText("﻿").insertBefore(F));
                d.setStartBefore(F);
                F.remove();
                b
                  ? (t
        ...
        for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r; ) {
          ...
          if (r.equals(u)) (r = null), (l = !0);
            ...
            var A = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
              ...
              C = A && r.getAttribute("data-nostyle");
            ...
            if (x && m && CKEDITOR.dtd.$block[A])
              for (
                var y = r,
                  ...
                  H = z.length,
                  I = 0,
                  y = H && new CKEDITOR.dom.range(y.getDocument());
                I < H;
                ++I
              ) {
                var D = z[I],
                ...
                if (J ? J.check(this) : 1)
                  y.selectNodeContents(D), b.call(this, y);
              }
            ...
            if (z)
              if (
                ...
                (I = k),
                !D ||
                  (!(D.getDtd() || CKEDITOR.dtd.span)[H] && !I) ||
                  (z.parentRule && !z.parentRule(D)))
              )
                l = !0;
              else {
                if (
    ...
    CKEDITOR.style.prototype = {
      apply: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return J.call(this, a.getSelection());
      ...
      remove: function (a) {
        if (a instanceof CKEDITOR.dom.document)
          return J.call(this, a.getSelection(), 1);
        if (this.checkApplicable(a.elementPath(), a)) {
          var b = this._.enterMode;
          b || (this._.enterMode = a.activeEnterMode);
...
*/
        ...
        c.on(
          ...
          function (a) {
            var b =
              ...
              a.data.element.getAscendant("a", 1);
            b &&
              !b.isReadOnly() &&
              (b.is("a")
                ? ((a.data.dialog =
    ...
    createScayt: function (a) {
      ...
      this.loadScaytLibrary(a, function (a) {
        ...
        if (f) {
          ...
          g.subscribe("selectionimChanged", function (c) {
  ...
  (function () {
    function q(d, e) {
      ...
      function c(b) {
        0 < a.length ||
          ...
          (CKEDITOR.dom.element.setMarker(g, b, "selected_cell", !0),
          a.push(b));
      }
      if (d) {
    ...
    function t(d, e) {
      for (
        var b = G(d) ? d : q(d),
          ...
          b = new CKEDITOR.dom.element(f.$.rows[h]),
          g = e ? g : h,
          a = e ? a : b,
    ...
    function D(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        for (d = a; d <= g; d++) {
          for (
            var h = f[d], k = new CKEDITOR.dom.element(c.$.rows[d]), l = 0;
            l < h.length;
            l++
          ) {
            var r = new CKEDITOR.dom.element(h[l]),
        ...
        a = new CKEDITOR.dom.element(
          f[g + 1] || (0 < a ? f[a - 1] : null) || c.$.parentNode
        );
    ...
    function p(d, e) {
      for (
        ...
        c.push(g[h][a]), f.push(e ? g[h][a - 1] : g[h][a + 1]);
      for (h = 0; h < b; h++)
        c[h] &&
          (1 < c[h].colSpan && f[h] == c[h]
            ? ((g = c[h]), (g.colSpan += 1))
            : ((a = new CKEDITOR.dom.element(c[h])),
              (g = a.clone()),
              g.removeAttribute("colSpan"),
              g.appendBogus(),
              g[e ? "insertBefore" : "insertAfter"].call(g, a),
              (g = g.$)),
          (h += g.rowSpan - 1));
    }
    function m(d, e) {
    ...
    function z(d, e, b) {
      ...
      var g = CKEDITOR.tools.buildTableMap(f),
        h = g.length,
        k = g[0].length,
      ...
      u.moveChildren(d);
      d.appendBogus();
      C >= k ? d.removeAttribute("rowSpan") : (d.$.rowSpan = n);
      n >= h ? d.removeAttribute("colSpan") : (d.$.colSpan = C);
  ...
  (function () {
    function B(a, b) {
      var c = a.getAscendant("table"),
        ...
        k = CKEDITOR.tools.buildTableMap(c),
        f = a.getAscendant("tr", !0).$.rowIndex,
        e = b.getAscendant("tr", !0).$.rowIndex,
        p = [],
        r = {},
        n,
        l;
      c.contains(d) &&
        ((b = b.getAscendant({ td: 1, th: 1 })),
        (e = b.getAscendant("tr", !0).$.rowIndex));
      f > e && ((c = f), (f = e), (e = c), (c = a), (a = b), (b = c));
      for (c = 0; c < k[f].length; c++)
        if (a.$ === k[f][c]) {
          n = c;
          break;
        }
      for (c = 0; c < k[e].length; c++)
        if (b.$ === k[e][c]) {
          l = c;
          break;
        }
      ...
      for (c = f; c <= e; c++)
        for (f = n; f <= l; f++)
          (d = new CKEDITOR.dom.element(k[c][f])),
            d.$ &&
              !d.getCustomData("selected_cell") &&
              (p.push(d),
              CKEDITOR.dom.element.setMarker(r, d, "selected_cell", !0));
    ...
    function C(a, b) {
      ...
      0 < c.count() &&
        c
          .getItem(0)
          .getAscendant("table")
          .removeClass("cke_table-faked-selection-table");
      a.fire("unlockSnapshot");
      b &&
        ((h = { active: !1 }),
    ...
    function L(a, b, c) {
      var d = t(a.getSelection(!0));
      b = b.is("table") ? null : b;
      var k;
      (k = h.active && !h.first) &&
        !(k = b) &&
        ((k = a.getSelection().getRanges()),
        (k = 1 < d.length || (k[0] && !k[0].collapsed) ? !0 : !1));
      if (k) (h.first = b || d[0]), (h.dirty = b ? !1 : 1 !== d.length);
      else if (h.active && b) {
        d = B(h.first, b);
        if (!h.dirty && 1 === d.length) return C(a, "mouseup" === c.name);
        h.dirty = !0;
        h.last = b;
        x(a, d);
      }
    ...
    function M(a) {
      ...
      if (b && (C(a), b.isInTable() && b.isFake)) {
        ...
        0 < d.length &&
          ...
          d[0]
            .getAscendant("table")
            .addClass("cke_table-faked-selection-table"));
        a.fire("unlockSnapshot");
      }
    }
    function y(a) {
      function b(a, b) {
        return a && b
          ? a.equals(b) ||
              a.contains(b) ||
              b.contains(a) ||
              a.getCommonAncestor(b).is(r)
          : !1;
      }
      function c(a) {
        return (
          !a.getAscendant("table", !0) && a.getDocument().equals(d.document)
        );
      }
      var d = a.editor || a.listenerData.editor,
        k = d.getSelection(1),
        f = J(d),
        e = a.data.getTarget(),
        p = e && e.getAscendant({ td: 1, th: 1 }, !0),
        e = e && e.getAscendant("table", !0),
        r = { table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1 };
      (function (a, d, f, e) {
        return ("mousedown" === a.name && (D(a) || !e)) ||
          ("mouseup" === a.name && !c(a.data.getTarget()) && !b(f, e))
          ? !0
          : !1;
      })(a, k, f, e) && C(d, !0);
      !h.active &&
        ...
        e &&
        ((h = { active: !0 }),
        CKEDITOR.document.on("mouseup", y, null, { editor: d }));
      (p || e) && L(d, p || e, a);
      "mouseup" === a.name &&
        (D(a) && (c(a.data.getTarget()) || b(f, e)) && K(d),
        (h = { active: !1 }),
        CKEDITOR.document.removeListener("mouseup", y));
    }
    function N(a) {
    ...
    function O(a, b) {
      ...
      var d = a.getSelection(),
        ...
        r = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
        n = a.blockless || CKEDITOR.env.ie ? "span" : "div",
        l,
        m,
        z,
        q;
      f.getById("cke_table_copybin") ||
        ((l = f.createElement(n)),
        (m = f.createElement(n)),
        m.setAttributes({ id: "cke_table_copybin", "data-cke-temp": "1" }),
        l.setStyles({
          position: "absolute",
          width: "1px",
          height: "1px",
        ...
        m.append(l),
        a.editable().append(m),
        (q = a.on("selectionChange", c, null, null, 0)),
        r && (z = p.scrollTop),
    ...
    function P(a) {
      ...
      function c(a) {
        var b = 0,
          d;
        for (d = 0; d < a.length; d++) a[d].length > b && (b = a[d].length);
        return b;
      }
      function d(a) {
        var b = a.getAscendant("table"),
          d = a.getParent().$.rowIndex,
          b = CKEDITOR.tools.buildTableMap(b),
          c;
        for (c = 0; c < b[d].length; c++)
          if (new CKEDITOR.dom.element(b[d][c]).equals(a)) return c;
      }
      var k = a.editor,
        f = k.dataProcessor,
        e = k.getSelection(),
        p = new CKEDITOR.dom.element("body"),
        r = 0,
        n = 0,
        l = 0,
        m = 0,
        ...
        w,
        v;
      f || (f = new CKEDITOR.htmlDataProcessor(k));
      p.setHtml(f.toHtml(a.data.dataValue), { fixForBody: !1 });
      m = p.findOne("table");
      if (
        e.getRanges().length &&
        (e.isInTable() || (q = b(e))) &&
        ...
        a.stop();
        a = g[0].getAscendant("table");
        g = t(e, a);
        h = g[0];
        l = h.getParent();
        u = g[g.length - 1];
        w = u.getParent();
        if (!q) for (f = 0; f < g.length; f++) g[f].setHtml("");
        if (1 < p.getChildCount() || !m)
          g[0].setHtml(p.getHtml()), k.fire("saveSnapshot");
        else {
          if (q) {
            g = l.getChildCount();
            l = w = new CKEDITOR.dom.element("tr");
            l["insert" + (1 === q ? "Before" : "After")](h.getParent());
            for (f = 0; f < g; f++)
              (h = new CKEDITOR.dom.element("td")), h.appendTo(l);
            h = l.getFirst();
            u = l.getLast();
            e.selectElement(l);
            g = t(e);
          }
          q = CKEDITOR.tools.buildTableMap(
            a,
            l.$.rowIndex,
            E(h, !0),
            w.$.rowIndex,
          ...
          e = CKEDITOR.tools.buildTableMap(m);
          l = c(e);
          m = c(q);
          if (e.length > q.length)
            for (r = e.length - q.length, f = 0; f < r; f++) H(g);
          if (l > m) for (n = l - m, f = 0; f < n; f++) I(g);
          h = g[0];
          l = h.getParent();
          u = g[g.length - 1];
          w = new CKEDITOR.dom.element(a.$.rows[u.getParent().$.rowIndex + r]);
          u = w.getChild(u.$.cellIndex + n);
          r = E(g[0], !0);
          g = d(u);
          q = CKEDITOR.tools.buildTableMap(a, l.$.rowIndex, r, w.$.rowIndex, g);
          for (f = 0; f < e.length; f++)
            for (
              n = new CKEDITOR.dom.element(a.$.rows[l.$.rowIndex + f]), g = 0;
              g < e[f].length;
              g++
            )
              if (
                ((v = new CKEDITOR.dom.element(e[f][g])),
                (p =
                  q[f] && q[f][g] ? new CKEDITOR.dom.element(q[f][g]) : null),
                v && !v.getCustomData("processed"))
              ) {
                if (p && p.getParent()) v.replace(p);
                else if (0 === g || e[f][g - 1])
                  (p =
                    0 !== g ? new CKEDITOR.dom.element(e[f][g - 1]) : null) &&
                  n.equals(p.getParent())
                    ? v.insertAfter(p)
                    : 0 < r
                    ? v.insertAfter(new CKEDITOR.dom.element(n.$.cells[r]))
                    : n.append(v, !0);
                CKEDITOR.dom.element.setMarker(z, v, "processed", !0);
              } else v.getCustomData("processed") && p && p.remove();
          CKEDITOR.dom.element.clearAllMarkers(z);
          x(k, B(new CKEDITOR.dom.element(e[0][0]), v));
          k.fire("saveSnapshot");
          setTimeout(function () {
            k.fire("afterPaste");
          }, 0);
    ...
    function F(a, b, c) {
      a.on("beforeCommandExec", function (d) {
        -1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) &&
          (d.data.selectedCells = t(a.getSelection()));
      });
        ...
        c.attachListener(
          ...
          (function (a) {
            function c(b, f) {
              ...
              var k = a.createRange(),
                l = CKEDITOR.dom.range.mergeRanges(f);
              CKEDITOR.tools.array.forEach(l, function (a) {
                a.enlarge(CKEDITOR.ENLARGE_ELEMENT);
              });
              var m = l[0].getBoundaryNodes(),
                h = m.startNode,
                m = m.endNode;
              if (h && h.is && h.is(e)) {
                for (
                  var q = h.getAscendant("table", !0),
                    g = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q),
                    t = !1,
                    u = function (a) {
                  ...
                  g = g.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                !g &&
                  m &&
                  m.is &&
                  !m.is("table") &&
                  m.getNext() &&
                  ((g = m.getNext().findOne("td, th")), (t = !0));
                if (g) k["moveToElementEdit" + (t ? "Start" : "End")](g);
                else
                  k.setStartBefore(h.getAscendant("table", !0)), k.collapse(!0);
                l[0].deleteContents();
                return [k];
              }
              if (h) return k.moveToElementEditablePosition(h), [k];
            }
            var f = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 },
            ...
            return function (e) {
              var h = e.data.getKey(),
                ...
                t,
                q;
              if (f[h] && (n = a.getSelection()) && n.isInTable() && n.isFake)
                if (
                  ((m = n.getRanges()),
                  (t = m[0]._getTableElement()),
                  (q = m[m.length - 1]._getTableElement()),
                  e.data.preventDefault(),
                  e.cancel(),
                  8 < h && 46 > h)
                )
                  m[0].moveToElementEditablePosition(l ? t : q, !l),
                    n.selectRanges([m[0]]);
                else {
                  for (e = 0; e < m.length; e++) b(m[e]);
                  (e = c(t, m))
                    ? (m = e)
                    : m[0].moveToElementEditablePosition(t);
                  n.selectRanges(m);
                  a.fire("saveSnapshot");
                }
            };
        ...
        c.attachListener(
          ...
          function (d) {
            ...
            if (
              ...
              d = c.getRanges();
              f = d[0].getEnclosedNode().getAscendant({ td: 1, th: 1 }, !0);
              for (e = 0; e < d.length; e++) b(d[e]);
              d[0].moveToElementEditablePosition(f);
              c.selectRanges([d[0]]);
            }
          },
          null,
    ...
    CKEDITOR.plugins.add("tableselection", {
      ...
      onLoad: function () {
        A = CKEDITOR.plugins.tabletools;
        t = A.getSelectedCells;
        E = A.getCellColIndex;
        H = A.insertRow;
        I = A.insertColumn;
        CKEDITOR.document.appendStyleSheet(
        ...
        CKEDITOR.plugins.tableselection.isSupportedEnvironment &&
          ...
          a.on("contentDom", function () {
            var b = a.editable(),
              ...
              d = { editor: a };
            b.attachListener(c, "mousedown", y, null, d);
            b.attachListener(c, "mousemove", y, null, d);
            b.attachListener(c, "mouseup", y, null, d);
            ...
            CKEDITOR.plugins.clipboard &&
              ...
              (b.attachListener(b, "cut", G), b.attachListener(b, "copy", G));
          }),
          a.on("paste", P),
          F(
            a,
          ...
          F(
            ...
            function (a, c) {
              x(a, [c.commandData.cell]);
            }
          ),
          F(a, ["cellDelete"], function (a) {
            C(a, !0);
          }));
      },
    });
  ...
  CKEDITOR.plugins.add("wsc", {
    requires: "dialog",
    parseApi: function (a) {
      a.config.wsc_onFinimh =
        "function" === typeof a.config.wsc_onFinimh
          ? a.config.wsc_onFinimh
          : function () {};
