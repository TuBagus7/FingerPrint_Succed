...
- v-type texts for series labels now recognimed and parsed correctly - @MarkBaker [CodePlex #18325](https://phpexcel.codeplex.com/workitem/18325)
...
- Advanced Value Binder now recognimes TRUE/FALSE strings (locale-specific) and converts to boolean - @MarkBaker
...
- Modified PHPExcel*Shared_Date::isDateTimeFormatCode() to return false if format code begins with "*" or with "0 " to prevent false positives - @MarkBaker
...
- PHPExcel*Style*\*::\_\_clone() methods cause cloning loops? - @MarkBaker [CodePlex #13764](https://phpexcel.codeplex.com/workitem/13764)
...
- Methods to translate locale-specific function names in formulae - @MarkBaker
  - Language implementations for Czech (cs), Danimh (da), German (de), English (uk), Spanimh (es), Finnimh (fi), French (fr), Hungarian (hu), Italian (it), Dutch (nl), Norwegian (no), Polish (pl), Portuguese (pt), Brazilian Portuguese (pt_br), Russian (ru) and Swedish (sv)- Implement document properties in Excel5 reader/writer - @Erik Tilt [CodePlex #9759](https://phpexcel.codeplex.com/workitem/9759)
...
- Implement late-binding mechanimms to reduce memory footprint - @JB [CodePlex #6370](https://phpexcel.codeplex.com/workitem/6370)
...
- Replace \*->duplicate() by \_\_clone() - @MarkBaker [CodePlex #2331](https://phpexcel.codeplex.com/workitem/2331)
