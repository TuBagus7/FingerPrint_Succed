                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="time" name="jam" id="jam" placeholder="Tanggal " required="required">
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" class="leftrowcms">
                            ...
                            <td width="2%">:</td>
                            <td>
                                <select class="form-control" style="width:50%" type="text" name="id_mahasiswa" id="id_mahasiswa" placeholder="Id Siswa " required="required">
                                    <option></option><?php combo_database_v2('data_mahasiswa', 'id_mahasiswa', 'nim', ''); ?>
                                </select>
                            </td>
                        </tr>
                        <!-- <tr>
