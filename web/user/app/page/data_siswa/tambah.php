                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control" style="width:50%" type="text" name="jenim_kelamin" id="jenim_kelamin" placeholder="Jenim Kelamin " required="required">
                                    <option></option><?php combo_enum('data_mahasiswa', 'jenim_kelamin', ''); ?>
                                </select>
                            </td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="varchar" name="password" id="password" placeholder="Password" required="required">
                            </td>
                        </tr>
