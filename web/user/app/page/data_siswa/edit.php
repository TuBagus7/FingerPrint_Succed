        ...
        <div class="content-box-content">
            <div id="postcustom">
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    ...
                    h-->
                        <input type="hidden" class="form-control" name="id_mahasiswa" value="<?php echo $data['id_mahasiswa']; ?>" readonly id="id_mahasiswa" required="required">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="number" name="id_sidik_jari" id="id_sidik_jari" placeholder="ID Fingerprint " required="required" value="<?php echo ($data['id_sidik_jari']); ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="varchar" name="nim" id="nim" placeholder="nim " required="required" value="<?php echo ($data['nim']); ?>">
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" class="leftrowcms">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <select class="form-control" style="width:50%" type="text" name="jenim_kelamin" id="jenim_kelamin" placeholder="Jenim Kelamin " required="required">
                                    <option value="<?php echo ($data['jenim_kelamin']); ?>">- <?php echo ($data['jenim_kelamin']); ?> -</option><?php combo_enum('data_mahasiswa', 'jenim_kelamin', ''); ?>
                                </select>
                            </td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="varchar" name="username" id="username" placeholder="Nama " required="required" value="<?php echo ($data['username']); ?>">
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" class="leftrowcms">
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="varchar" name="password" id="password" placeholder="Nama " required="required" value="<?php echo ($data['password']); ?>">
                            </td>
                        </tr>
