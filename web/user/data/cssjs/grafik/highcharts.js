...
(function (T, K) {
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      ...
      update: function () {
        ...
        if (this[g + "Setter"]) this[g + "Setter"]();
          ...
          a.attr
            ? a.element && a.attr(g, e, null, !0)
            : (a.style[g] = e + this.unit);
        t && t.call(a, e, this);
      },
      run: function (r, g, e) {
        var t = this,
        ...
        r !== g || this.elem["forceAnimate:" + this.prop]
          ? ((this.startTime = +new Date()),
            ...
            (l.elem = this.elem),
            (l.prop = this.prop),
            l() && 1 === a.timers.push(l) && u(c))
          : (delete w.curAnim[this.prop],
            w.complete &&
              0 === a.keys(w.curAnim).length &&
              w.complete.call(this.elem));
      },
      step: function (r) {
        var g = +new Date(),
          e,
        ...
        w.attr && !w.element
          ...
          ? ((this.now = this.end),
            ...
            e && l && l.call(w),
            (r = !1))
          : ((this.pos = t.easing((g - this.startTime) / u)),
      ...
      initPath: function (r, g, e) {
        function t(a) {
          ...
          for (b = a.length; b--; )
            (f = "M" === a[b] || "L" === a[b]),
              ...
              f &&
                c &&
                a.splice(b + 1, 0, a[b + 1], a[b + 2], a[b + 1], a[b + 2]);
        }
        function w(a, f) {
          for (; a.length < p; ) {
            a[0] = f[p - a.length];
        ...
        function l(a, b) {
          for (var c = (p - a.length) / x; 0 < c && c--; )
            (f = a.slice().splice(a.length / z - x, x * z)),
              (f[0] = b[p - x - c * x]),
    ...
    a.pad = function (a, g, e) {
      return (
        Array((g || 2) + 1 - String(a).replace("-", "").length).join(e || 0) + a
      );
    };
    a.relativeLength = function (a, g, e) {
      return /%$/.test(a)
        ? (g * parseFloat(a)) / 100 + (e || 0)
        : parseFloat(a);
    };
        ...
        ? ((e = (e = r.match(t)) ? e[1] : -1),
          null !== g &&
            (g = a.numberFormat(
              ...
              e,
              w.decimalPoint,
              -1 < r.indexOf(",") ? w.thousandsSep : ""
            )))
        : (g = (e || a.time).dateFormat(r, g));
      return g;
    };
    ...
    a.numberFormat = function (r, g, e, t) {
      ...
      -1 === g
        ...
        ? g &&
          ...
          ((u = g + +d[1]),
          0 <= u
            ? ((d[0] = (+d[0]).toExponential(u).split("e")[0]), (g = u))
            : ((d[0] = d[0].split(".")[0] || 0),
              (r = 20 > g ? (d[0] * Math.pow(10, d[1])).toFixed(g) : 0),
              (d[1] = 0)))
        : (g = 2);
      c = (
        Math.abs(d[1] ? d[0] : r) + Math.pow(10, -Math.max(g, l) - 1)
      ).toFixed(g);
      l = String(a.pInt(c));
    ...
    a.map = function (a, g) {
      for (var e = [], t = 0, w = a.length; t < w; t++)
    ...
    a.addEvent = function (r, g, e) {
      ...
      t =
        "function" === typeof r && r.prototype
          ? (r.prototype.protoEvents = r.prototype.protoEvents || {})
          : (r.hcEvents = r.hcEvents || {});
      w && w.call(r, g, e, !1);
      t[g] || (t[g] = []);
      t[g].push(e);
      return function () {
    ...
    a.fireEvent = function (r, g, e, t) {
      var w, l, u, c, d;
      e = e || {};
      F.createEvent && (r.dispatchEvent || r.fireEvent)
        ? ((w = F.createEvent("Events")),
          w.initEvent(g, !0, !0),
          a.extend(w, e),
          r.dispatchEvent ? r.dispatchEvent(w) : r.fireEvent(g, w))
        : a.each(["protoEvents", "hcEvents"], function (k) {
            if (r[k])
              for (
                l = r[k][g] || [],
                  u = l.length,
    ...
    a.animate = function (r, g, e) {
      ...
      a.isObject(e) ||
        ((c = arguments),
        (e = { duration: c[2], easing: c[3], complete: c[4] }));
      ...
      a.objectEach(g, function (c, k) {
        ...
        l = null;
        "d" === k
          ? ((u.paths = u.initPath(r, r.d, g.d)),
            (u.toD = g.d),
            (t = 0),
            (l = 1))
          : r.attr
          ? (t = r.attr(k))
          : ((t = parseFloat(a.getStyle(r, k)) || 0),
            "opacity" !== k && (w = "px"));
        l || (l = c);
      ...
      init: function (e) {
        ...
        if (
          ...
          (e &&
            ...
            7 === g
              ? (w = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1])
              : 4 === g &&
                (w = [
                  ((e & 3840) >> 4) | ((e & 3840) >> 8),
                  ((e & 240) >> 4) | (e & 240),
      ...
      tweenTo: function (a, g) {
        ...
        l.length && e && e.length
          ? ((a = 1 !== l[3] || 1 !== e[3]),
            (g =
              (a ? "rgba(" : "rgb(") +
              Math.round(l[0] + (e[0] - l[0]) * (1 - g)) +
              "," +
              Math.round(l[1] + (e[1] - l[1]) * (1 - g)) +
              "," +
              Math.round(l[2] + (e[2] - l[2]) * (1 - g)) +
              (a ? "," + (l[3] + (e[3] - l[3]) * (1 - g)) : "") +
              ")"))
          : (g = a.input || "none");
        return g;
  ...
  (function (a) {
    ...
    p(C.prototype, {
      ...
      animate: function (y, h, b) {
        ...
        0 !== h.duration
          ? (b && (h.complete = b), r(this, y, h))
          : (this.attr(y, null, b), h.step && h.step.call(this));
        return this;
      },
      complexColor: function (y, h, b) {
        ...
        a.fireEvent(
          ...
          function () {
            y.radialGradient
              ? (c = "radialGradient")
              : y.linearGradient && (c = "linearGradient");
            c &&
              ((d = y[c]),
              (I = f.gradients),
              (A = y.stops),
              ...
              I[z]
                ? (q = I[z].attr("id"))
                : ((d.id = q = a.uniqueKey()),
                  (I[z] = p = f.createElement(c).attr(d).add(f.defs)),
                  (p.radAttr = m),
                  (p.stops = []),
                  x(A, function (y) {
                    0 === y[1].indexOf("rgba")
      ...
      applyTextOutline: function (y) {
        ...
        -1 !== y.indexOf("contrast") &&
          (y = y.replace(/contrast/g, this.renderer.getContrast(h.style.fill)));
        y = y.split(" ");
        v = y[y.length - 1];
      ...
      attr: function (a, h, b, c) {
        ...
        "string" === typeof a &&
          ...
          ((y = a), (a = {}), (a[y] = h));
        "string" === typeof a
          ? (d = (this[a + "Getter"] || this._defaultGetter).call(this, a, f))
          : (M(
              a,
              function (y, h) {
                m = !1;
                ...
                this.symbolName &&
                  ...
                  (v || (this.symbolAttr(a), (v = !0)), (m = !0));
                !this.rotation ||
                  ("x" !== h && "y" !== h) ||
                  (this.doTransform = !0);
                m ||
                  ((I = this[h + "Setter"] || this._defaultSetter),
                  I.call(this, y, h, f),
                  this.shadows &&
          ...
          : f &&
            a.push(
              "rotate(" +
                f +
                " " +
                G(this.rotationOriginX, m.getAttribute("x"), 0) +
                " " +
                G(this.rotationOriginY, m.getAttribute("y") || 0) +
                ")"
            );
      ...
      align: function (a, h, b) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = h), !b || H(b))
          )
      ...
      getBBox: function (a, h) {
        ...
        u(I) &&
          ((q = I.toString()),
          -1 === q.indexOf("\x3c") && (q = q.replace(/[0-9]/g, "0")),
          (q += ["", h || 0, m, this.textWidth, d && d.textOverflow].join()));
        q && !a && (y = n[q]);
        if (!y) {
          if (f.namespaceURI === this.SVG_NS || b.forExport) {
            try {
              (A =
                ...
                function (a) {
                  x(
                    f.querySelectorAll(".highcharts-text-outline"),
                    function (y) {
                      y.style.display = a;
                    }
                  );
      ...
      destroy: function () {
        ...
        v &&
          c &&
          (x(c.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (c = 1; c <= m; c++)
            (v = f.cloneNode(0)),
              ...
              b &&
                (g(v, "height", Math.max(g(v, "height") - d, 0)),
                (v.cutHeight = d)),
              h
                ? h.element.appendChild(v)
                : f.parentNode && f.parentNode.insertBefore(v, f),
              y.push(v);
          this.shadows = y;
        }
        return this;
      ...
      titleSetter: function (a) {
        ...
        h ||
          ((h = k.createElementNS(this.SVG_NS, "title")),
      ...
      zIndexSetter: function (a, b) {
        ...
        var p;
        u(a) &&
          ((d.zIndex = a), (a = +a), this[b] === a && (f = !1), (this[b] = a));
        if (f) {
    ...
    p(F.prototype, {
      ...
      init: function (a, h, b, c, v, f) {
        ...
        this.alignedObjects = [];
        this.url =
          (q || m) && k.getElementsByTagName("base").length
            ? N.location.href
                .replace(/#.*?$/, "")
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            k.createTextNode("Created with Highcharts 6.1.0")
          );
        ...
        q &&
          ...
          h(),
          (this.unSubPixelFix = D(N, "resize", h)));
      },
      getStyle: function (a) {
        return (this.style = p(
          {
        ...
        var c = a.element,
          ...
          J = function (a) {
            ...
            b = /(px|em)$/.test(a && a.style.fontSize)
              ? a.style.fontSize
              : u || v.style.fontSize || 12;
            return E
              ? h(E)
              : v.fontMetrics(b, a.getAttribute("style") ? a : c).h;
          },
          N = function (a, h) {
        ...
        if (l !== a.textCache) {
          ...
          y || e || B || q || -1 !== d.indexOf(" ")
            ? (n && n.appendChild(c),
              ...
              x(d, function (h, b) {
                ...
                x(d, function (h) {
                  if ("" !== h || 1 === d.length) {
                    ...
                    if ((E = t(h, "style")))
                      (E = E.replace(/(;| |^)color([ :])/, "$1fill$2")),
                        g(n, "style", E);
                    (z = t(h, "href")) &&
                      !f &&
                      (g(n, "onclick", 'location.href\x3d"' + z + '"'),
                      g(n, "class", "highcharts-anchor"),
                      w(n, { cursor: "pointer" }));
                    ...
                    if (" " !== h) {
                      ...
                      if (q) {
                        ...
                        var e = [],
                          ...
                          u = a.rotation;
                        for (
                          B && (p = v.applyEllipsis(a, n, h, q));
                          !B && z && (m.length || e.length);
              ...
              p && a.attr("title", N(a.textStr, ["\x26lt;", "\x26gt;"])),
              n && n.removeChild(c),
              e && a.applyTextOutline && a.applyTextOutline(e))
            : c.appendChild(k.createTextNode(N(d)));
        }
      },
      ...
      arc: function (a, h, b, c, v, f) {
        B(a)
          ? ((c = a), (h = c.y), (b = c.r), (a = c.x))
          : (c = { innerR: c, start: v, end: f });
      ...
      rect: function (a, h, b, c, v, f) {
        ...
        a = B(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: h, width: Math.max(b, 0), height: Math.max(c, 0) };
      ...
      symbol: function (a, h, b, c, v, f) {
        var d = this,
          ...
          q =
            u(h) &&
            A &&
            A.call(this.symbols, Math.round(h), Math.round(b), c, v, f),
          E,
          z;
        A
          ? ((m = this.path(q)),
            m.attr("fill", "none"),
            p(m, { symbolName: y, x: h, y: b, width: c, height: v }),
            f && p(m, f))
          : n &&
            ((E = a.match(I)[1]),
            (m = this.image(E)),
            (m.imgwidth = G(O[E] && O[E].width, f && f.width)),
            (m.imgheight = G(O[E] && O[E].height, f && f.height)),
            (z = function () {
            ...
            x(["width", "height"], function (a) {
              m[a + "Setter"] = function (a, h) {
                ...
                this[h] = a;
                u(c) &&
                  (this.element && this.element.setAttribute(h, c),
                  this.alignByTranslate ||
                    ((b[v] = ((this[h] || 0) - c) / 2), this.attr(b)));
              };
            }),
            u(h) && m.attr({ x: h, y: b }),
            (m.isImg = !0),
            u(m.imgwidth) && u(m.imgheight)
              ? z()
      ...
      symbols: {
        ...
        arc: function (a, h, b, c, v) {
          var f = v.start,
            ...
            I = v.end - 0.001;
          b = v.innerR;
          c = G(v.open, 0.001 > Math.abs(v.end - v.start - 2 * Math.PI));
          var n = Math.cos(f),
            p = Math.sin(f),
            y = Math.cos(I),
            I = Math.sin(I);
          v = 0.001 > v.end - f - Math.PI ? 0 : 1;
          d = [
            "M",
            a + d * n,
            h + m * p,
        ...
        callout: function (a, h, b, c, v) {
          ...
          m && m > b
            ...
            : m && 0 > m
            ? v > h + d && v < h + c - d
              ? I.splice(33, 3, "L", a, v + 6, a - 6, v, a, v - 6, a, h + f)
              : I.splice(33, 3, "L", a, c / 2, m, v, a, c / 2, a, h + f)
            : v && v > c && m > a + d && m < a + b - d
            ? I.splice(
                23,
                3,
            ...
            : v &&
              ...
              m > a + d &&
              m < a + b - d &&
              I.splice(3, 3, "L", m - 6, h, m, h - 6, m + 6, h, b - f, h);
          return I;
        },
      },
      ...
      label: function (h, b, c, f, d, m, I, n, A) {
        ...
        r = function () {
          ...
          t &&
            (y ||
              ...
              (h.x = a),
              (h.y = (n ? -N : 0) + a)),
            (h.width = Math.round(q.width)),
            (h.height = Math.round(q.height)),
            y.attr(p(h, J)),
            (J = {}));
        };
        R = function () {
          ...
          u(g) &&
            e &&
            ("center" === H || "right" === H) &&
            (a += { center: 0.5, right: 1 }[H] * (g - e.width));
          if (a !== z.x || h !== z.y)
        ...
        q.xSetter = function (a) {
          q.x = a;
          P &&
            ((a -= P * ((g || e.width) + 2 * B)), (q["forceAnimate:x"] = !0));
          l = Math.round(a);
          q.attr("translateX", l);
        };
  ...
  (function (a) {
    ...
    e(a.SVGElement.prototype, {
        ...
        if (this.added) {
          ...
          if ("SPAN" === f.tagName) {
            ...
            A &&
              ...
              (this.oldTextWidth = m));
            E !== this.cTT &&
              ((l = a.fontMetrics(f.style.fontSize).b),
              r(B) &&
                B !== (this.oldRotation || 0) &&
                this.setSpanRotation(B, x, l),
              this.getSpanCorrection(
                (!r(B) && this.textPxLength) || f.offsetWidth,
                l,
                x,
                B,
                q
      ...
      setSpanRotation: function (a, c, b) {
        ...
        f[d + (t ? "Origin" : "-origin")] = f.transformOrigin =
          100 * c + "% " + b + "px";
        D(this.element, f);
      },
    ...
    e(d.prototype, {
      getTransformKey: function () {
        return w && !/Edge/.test(k.navigator.userAgent)
          ? "-ms-transform"
          : l
          ? "-webkit-transform"
          : t
  ...
  (function (a) {
    ...
    a.Time.prototype = {
      ...
      update: function (e) {
        ...
        (this.variableTimezone = !(l && !e.getTimezoneOffset && !e.timezone)) ||
        this.timezoneOffset
      ...
      makeTime: function (e, l, u, c, d, k) {
        var x, p, f;
        this.useUTC
          ? ((x = this.Date.UTC.apply(0, arguments)),
            (p = this.getTimezoneOffset(x)),
            (x += p),
            (f = this.getTimezoneOffset(x)),
            p !== f
              ? (x += f - p)
              : p - 36e5 !== this.getTimezoneOffset(x - 36e5) ||
                a.isSafari ||
                (x -= 36e5))
          : (x = new this.Date(
              e,
      ...
      getTimeTicks: function (a, l, u, c) {
        ...
        if (C(l)) {
          d.set(
            "Milliseconds",
            f,
            b >= e.second ? 0 : n * Math.floor(d.get("Milliseconds", f) / n)
          );
          b >= e.second &&
            d.set(
              "Seconds",
              f,
              b >= e.minute ? 0 : n * Math.floor(d.get("Seconds", f) / n)
            );
          b >= e.minute &&
            d.set(
              "Minutes",
              f,
              b >= e.hour ? 0 : n * Math.floor(d.get("Minutes", f) / n)
            );
          b >= e.hour &&
            d.set(
              "Hours",
              f,
              b >= e.day ? 0 : n * Math.floor(d.get("Hours", f) / n)
            );
          b >= e.day &&
            d.set(
              "Date",
              f,
              b >= e.month ? 1 : n * Math.floor(d.get("Date", f) / n)
            );
          b >= e.month &&
            (d.set(
              "Month",
              f,
              b >= e.year ? 0 : n * Math.floor(d.get("Month", f) / n)
            ),
            (p = d.get("FullYear", f)));
          ...
          d.variableTimezone &&
            (z =
              u - l > 4 * e.month ||
              d.getTimezoneOffset(l) !== d.getTimezoneOffset(u));
          f = f.getTime();
          for (l = 1; f < u; )
            k.push(f),
              (f =
                b === e.year
                  ...
                  : !z || (b !== e.day && b !== e.week)
                  ? z && b === e.hour && 1 < n
                    ? d.makeTime(p, c, J, q + l * n)
                    : f + b * n
                  : d.makeTime(p, c, J + l * n * (b === e.day ? 1 : 7))),
              l++;
          k.push(f);
          b <= e.hour &&
            1e4 > k.length &&
            F(k, function (a) {
              0 === a % 18e5 &&
                "000000000" === d.dateFormat("%H%M%S%L", a) &&
                (x[a] = "day");
            });
        }
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        a.isDatetimeAxis &&
          f &&
          (z = g.dateTimeLabelFormats[f.higherRanks[x] || f.unitName]);
        this.isFirst = b;
        this.isLast = n;
      ...
      handleOverflow: function (a) {
        var e = this.axis,
          ...
          g = t(
            e.labelRight,
            Math.max(e.isRadial ? 0 : e.pos + e.len, k - g[1])
          ),
          f = this.label,
          b = this.rotation,
        ...
        if (b || !1 === c.overflow)
          0 > b && d - n * z < p
            ? (B = Math.round(d / Math.cos(b * w) - p))
            : 0 < b &&
              d + n * z > g &&
              (B = Math.round((k - d) / Math.cos(b * w)));
        else if (
          ((k = d + (1 - n) * z),
          d - n * z < p
            ? (q = a.x + q * (1 - n) - p)
          ...
          q < l &&
            "center" === e.labelAlign &&
            (a.x += L * (l - q - n * (l - Math.min(z, q)))),
          z > q || (e.autoRotation && (f.styles || {}).width))
        )
          B = q;
        B &&
          ((H.width = B),
          (c.style || {}).textOverflow || (H.textOverflow = "ellipsis"),
          f.css(H));
      },
      getPosition: function (e, g, c, d) {
        ...
        e = {
          x: e
            ? a.correctFloat(k.translate(g + c, null, null, d) + k.transB)
            : k.left +
              k.offset +
              (k.opposite
                ? ((d && x.oldChartWidth) || x.chartWidth) - k.right - k.left
                : 0),
          y: e
            ? p - k.bottom + k.offset - (k.opposite ? k.height : 0)
            : a.correctFloat(p - k.translate(g + c, null, null, d) - k.transB),
        };
        ...
        F(l) ||
          (l =
            0 === b.side
              ...
              : 2 === b.side
              ? q.y + 8
              : Math.cos(c.rotation * w) * (q.y - c.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function (a, e, c) {
        ...
        if (
          !a &&
          g &&
          (a = d.getPlotLinePath(f + n, g.strokeWidth() * c, a, !0))
        )
          g[this.isNew ? "attr" : "animate"]({ d: a, opacity: e });
      },
          ...
          z &&
            ((this.mark = n =
              g
                ...
                .add(d.axisGroup)),
            n.attr({ stroke: k, "stroke-width": q })),
          n[z ? "attr" : "animate"]({
      ...
      renderLabel: function (a, e, c, d) {
        ...
        f &&
          g(u) &&
          ((f.xy = a = this.getLabelPosition(u, a, f, x, b, k, d, n)),
          (this.isFirst && !this.isLast && !t(p.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !t(p.showLastLabel, 1))
            ? (z = !1)
            : !x ||
              b.step ||
              b.rotation ||
  ...
  var V = (function (a) {
    ...
    a.extend(G.prototype, {
      ...
      init: function (a, c) {
        ...
        v.side =
          c.side || (v.horiz ? (v.opposite ? 0 : 2) : v.opposite ? 1 : 3);
        v.setOptions(c);
        var f = this.options,
          d = f.type;
        ...
        v.crosshair = H(
          f.crosshair,
          E(a.options.tooltip.crosshairs)[h ? 0 : 1],
          !1
        );
        c = v.options.events;
        -1 === b(v, a.axes) &&
          (h ? a.axes.splice(a.xAxis.length, 0, v) : a.axes.push(v),
          a[v.coll].push(v));
        v.series = v.series || [];
        a.inverted &&
          !v.isZAxis &&
          ...
          c(a.series, function (h) {
            if (h.visible || !b.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis)
                (v = h.xData),
                  v.length &&
                    ...
                    z(h) ||
                      ...
                      ((v = f(v, z)), (h = r(v)), (d = D(v))),
                    v.length &&
                      ((a.dataMin = Math.min(H(a.dataMin, v[0], h), h)),
                      (a.dataMax = Math.max(H(a.dataMax, v[0], d), d))));
              else if (
                (h.getExtremes(),
                (d = h.dataMax),
                (h = h.dataMin),
                w(h) &&
                  w(d) &&
                  ((a.dataMin = Math.min(H(a.dataMin, h), h)),
                  (a.dataMax = Math.max(H(a.dataMax, d), d))),
                w(c) && (a.threshold = c),
      ...
      translate: function (a, b, c, f, d, m) {
        ...
        b
          ? ((a = (a * v + I - p) / q + f), d && (a = h.lin2val(a)))
          : (d && (a = h.val2lin(a)),
            (a = z(f)
              ? v * (a - f) * q + I + v * p + (z(m) ? q * m : 0)
              : void 0));
        return a;
      },
      ...
      getPlotLinePath: function (a, b, c, f, d) {
        ...
        z(d)
          ? this.horiz
            ? ((I = m),
              (q = p - this.bottom),
              (a = c = A(a, v, v + this.width)))
            : ((a = v),
              (c = n - this.right),
              (I = q = A(I, m, m + this.height)))
          : ((e = !0), (f = !1));
        return e && !f
          ? null
          : h.renderer.crispLine(["M", a, I, "L", c, q], b || 1);
      },
        ...
        if (n && n / d < a.len / 3)
          if (a.isLog)
            c(this.paddedTicks, function (h, b, c) {
              b &&
                m.push.apply(m, a.getLogTickPositions(d, c[b - 1], c[b], !0));
            });
      ...
      adjustForMinRange: function () {
        ...
        f - b < this.minRange &&
          ...
          (b = D(d)),
          (f = [b + k, H(a.max, b + k)]),
          m && (f[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (f = r(f)),
          f - b < k && ((d[0] = f - k), (d[1] = H(a.min, f - k)), (b = D(d))));
        this.min = b;
        this.max = f;
      },
      getClosest: function () {
        ...
        0 < b.length &&
          ...
          c(this.series || [], function (a) {
            ...
            c(a.points, function (b, c) {
              ...
              b.options &&
                ((f = h.nameToX(b)),
                void 0 !== f && f !== b.x && ((b.x = f), (a.xData[c] = f)));
            });
          }));
      },
      setAxisTranslation: function (a) {
        ...
        if (A || n || f)
          (d = h.getClosest()),
            p
              ? ((m = p.minPointOffset), (q = p.pointRangePadding))
              : c(h.series, function (a) {
                  var b = n
                    ? 1
                    : A
                    ? H(a.options.pointRange, d, 0)
                    : h.axisPointRange || 0;
        ...
        h.translationSlope =
          h.transA =
          e =
            h.options.staticScale || h.len / (b + q || 1);
      ...
      setTickInterval: function (h) {
        ...
        r = H(b.userMax, d.max);
        A
          ? ((b.linkedParent = f[b.coll][d.linkedTo]),
            (f = b.linkedParent.getExtremes()),
            (b.min = H(f.min, f.dataMin)),
            (b.max = H(f.max, f.dataMax)),
            d.type !== b.linkedParent.options.type && a.error(11, 1))
          : (!l &&
              w(u) &&
              (b.dataMin >= u
                ? ((t = u), (g = 0))
                : b.dataMax <= u && ((J = u), (E = 0))),
            (b.min = H(M, t, b.dataMin)),
            (b.max = H(r, J, b.dataMax)));
        m &&
          (b.positiveValuesOnly &&
            !h &&
            0 >= Math.min(b.min, H(b.dataMin, b.min)) &&
            a.error(10, 1),
        ...
        b.adjustForMinRange();
        !(G || b.axisPointRange || b.usePercentage || A) &&
          w(b.min) &&
          w(b.max) &&
          (f = b.max - b.min) &&
          (!w(M) && g && (b.min -= f * g), !w(r) && E && (b.max += f * E));
        ...
        l &&
          w(b.dataMin) &&
          ((u = u || 0),
          !w(M) && b.min < u && b.dataMin >= u
            ? (b.min = u)
            : !w(r) && b.max > u && b.dataMax <= u && (b.max = u));
        b.tickInterval =
          b.min === b.max || void 0 === b.min || void 0 === b.max
            ? 1
            : A && !B && x === b.linkedParent.options.tickPixelInterval
            ? (B = b.linkedParent.tickInterval)
            : H(
                B,
                this.tickAmount
                  ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1)
                  : void 0,
                G ? 1 : ((b.max - b.min) * x) / Math.max(b.len, x)
              );
        n &&
          !h &&
      ...
      alignToOthers: function () {
        ...
        !1 === this.chart.options.chart.alignTicks ||
          ...
          !1 === f.endOnTick ||
          this.isLog ||
          c(this.chart[this.coll], function (h) {
            var c = h.options,
      ...
      setAxisSize: function () {
        var b = this.chart,
          ...
          f = c.offsets || [0, 0, 0, 0],
          d = this.horiz,
          m = (this.width = Math.round(
            a.relativeLength(H(c.width, b.plotWidth - f[3] + f[1]), b.plotWidth)
          )),
          q = (this.height = Math.round(
            a.relativeLength(
              H(c.height, b.plotHeight - f[0] + f[2]),
              b.plotHeight
            )
          )),
          p = (this.top = Math.round(
            a.relativeLength(
              H(c.top, b.plotTop + f[0]),
              b.plotHeight,
              b.plotTop
            )
          )),
      ...
      unsquish: function () {
        var a = this.options.labels,
          ...
          d = f,
          m =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / f),
          q,
          p = a.rotation,
          n = this.labelMetrics(),
          A,
        ...
        b
          ? (E =
              ...
              (w(p)
                ? [p]
                : m < H(a.autoRotationLimit, 80) && a.autoRotation)) &&
            c(E, function (a) {
              var b;
              if (a === p || (a && -90 <= a && 90 >= a))
                (A = z(Math.abs(n.h / Math.sin(l * a)))),
                  (b = A + Math.abs(a / 360)),
                  b < k && ((k = b), (q = a), (d = A));
            })
          : a.step || (d = z(n.h));
          ...
          for (z = "clip", n = f.length; !q && n--; )
            if (((B = f[n]), (B = d[B].label)))
              B.styles && "ellipsis" === B.styles.textOverflow
                ...
                : B.textPxLength > p && B.css({ width: p + "px" }),
                B.getBBox().height > this.len / f.length - (A.h - A.f) &&
                  (B.specificTextOverflow = "ellipsis");
        e.rotation &&
          ((E = g > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight),
          k || (z = "ellipsis"));
        if (
        ...
        c(f, function (a) {
          ...
          b &&
            ...
            !E ||
              ...
              ((h.width = E),
              k || (h.textOverflow = b.specificTextOverflow || z),
              b.css(h)),
      ...
      addTitle: function (a) {
        ...
        this.axisTitle ||
          ...
          (this.axisTitle = b
            ...
            .attr({ zIndex: 7, rotation: f.rotation || 0, align: d })
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ((a.gridGroup = f
            ...
            .addClass(
              "highcharts-" + this.coll.toLowerCase() + "-grid " + (J || "")
            )
            .add(M)),
          (a.axisGroup = f
            .g("axis")
            .attr({ zIndex: d.zIndex || 2 })
            .addClass("highcharts-" + this.coll.toLowerCase() + " " + (J || ""))
            .add(M)),
          (a.labelGroup = f
            .g("axis-labels")
            .attr({ zIndex: G.zIndex || 7 })
            .addClass(
              "highcharts-" + a.coll.toLowerCase() + "-labels " + (J || "")
            )
            .add(M)));
        A || a.isLinked
          ? (c(m, function (b, f) {
            ...
            a.staggerLines && (u *= a.staggerLines),
            (a.labelOffset = u * (a.opposite ? -1 : 1)))
          : B(q, function (a, b) {
              a.destroy();
              delete q[b];
            });
        ...
        l[n] = Math.max(
          l[n],
          a.axisTitleMargin + E + t * a.offset,
          g,
          A && m.length && r ? r[0] + t * a.offset : 0
        );
      ...
      getLinePath: function (a) {
        ...
        return b.renderer.crispLine(
          [
            ...
            h ? c : this.top,
            "L",
            h ? b.chartWidth - this.right : d,
            h ? c : b.chartHeight - this.bottom,
          ],
          a
        );
      },
      ...
      renderTick: function (a, b) {
        ...
        if (!f || (a >= this.min && a <= this.max))
          c[a] || (c[a] = new M(this, a)),
            d && c[a].isNew && c[a].render(b, !0, 0.1),
            c[a].render(b);
      },
      render: function () {
        var b = this,
        ...
        if (b.hasData() || q)
          b.minorTickInterval &&
            ...
            p.length &&
              ...
              u &&
                (0 === b.min || b.single) &&
                (e[-1] || (e[-1] = new M(b, -1, null, !0)), e[-1].render(-1))),
            G &&
              c(p, function (c, d) {
                ...
                0 === d % 2 &&
                  c < b.max &&
                  r <= b.max + (f.polar ? -u : u) &&
                  (g[c] || (g[c] = new a.PlotLineOrBand(b)),
                  (J = c + u),
                  (g[c].options = {
            ...
            b._addedPlotLB ||
              (c((d.plotLines || []).concat(d.plotBands || []), function (a) {
        ...
        n &&
          ...
          z(d.y)
            ? (n[n.isNew ? "attr" : "animate"](d), (n.isNew = !1))
          ...
          w(h) &&
            (f =
              this.getPlotLinePath(
                b && (this.isXAxis ? b.x : H(b.stackY, b.y)),
                null,
                null,
                null,
                h
          ...
          m ||
            ((this.cross = m =
              this.chart.renderer
                ...
                .attr({ zIndex: H(c.zIndex, 2) })
                .add()),
            m
              .attr({
                stroke:
                  c.color ||
                  (d ? g("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
                "stroke-width": H(c.width, 1),
              })
              .css({ "pointer-events": "none" }),
            c.dashStyle && m.attr({ dashstyle: c.dashStyle }));
          m.show().attr({ d: f });
  ...
  (function (a) {
    ...
    C.prototype.normalizeTimeTickInterval = function (a, e) {
      ...
      for (
        ...
        (w = r[e[0]]),
        (l = e[1]),
        g[u + 1] && a <= (w * l[l.length - 1] + r[g[u + 1][0]]) / 2);
        u++
      );
      ...
      if (0.5 <= a)
        ...
        for (
          ...
          for (x = e.length, k = 0; k < x && !b; k++)
            (p = this.log2lin(this.lin2log(c) * e[k])),
        ...
        (t = this.lin2log(t)),
          ...
          (a = g(
            ...
            ((e.tickPixelInterval / (l ? 5 : 1)) * (w - t)) /
              ((l ? c / this.tickPositions.length : c) || 1)
          )),
          (a = r(a, null, F(a))),
  ...
  (function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        J
          ? ((B = { stroke: H, "stroke-width": k.width }),
            k.dashStyle && (B.dashstyle = k.dashStyle))
          : z &&
            (H && (B.fill = H),
            k.borderWidth &&
              ((B.stroke = k.borderColor),
              (B["stroke-width"] = k.borderWidth)));
        A.zIndex = m;
        G += "-" + m;
        (H = c.plotLinesAndBandsGroups[G]) ||
          (c.plotLinesAndBandsGroups[G] = H =
            M.g("plot-" + G)
              .attr(A)
              .add());
      ...
      renderLabel: function (a, c, d, e) {
        ...
        k ||
          ...
          (k.zIndex = e),
          (this.label = k = p.text(a.text, 0, 0, a.useHTML).attr(k).add()),
          k.css(a.style));
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function (a, c) {
        ...
        if (e && d)
          for (
            a && ((b = e.toString() === d.toString()), (f = 0)), a = 0;
            a < e.length;
            a += 6
          )
            p && d[a + 1] === e[a + 1]
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function (c, d, e, g) {
        var p = this,
          ...
          b =
            ...
            !p.isHidden &&
            (1 < Math.abs(c - f.x) || 1 < Math.abs(d - f.y)),
      ...
      getAnchor: function (a, d) {
        ...
        this.followPointer &&
          d &&
          (void 0 === d.chartX && (d = e.pointer.normalize(d)),
          (c = [d.chartX - e.plotLeft, d.chartY - f]));
        c ||
          (C(a, function (a) {
            l = a.series.yAxis;
            q = a.series.xAxis;
      ...
      refresh: function (c, d) {
        ...
        g.enabled &&
          (a.clearTimeout(this.hideTimer),
          (this.followPointer = w(f)[0].series.tooltipOptions.followPointer),
          (b = this.getAnchor(f, d)),
          (d = b[0]),
          (p = b[1]),
          !n || (f.series && f.series.noSharedTooltip)
            ? (n = f.getLabelConfig())
            : (C(f, function (a) {
                a.setState("hover");
          ...
          (n = e.call(n, this)),
          (l = f.series),
          (this.distance = t(l.tooltipOptions.distance, 16)),
          !1 === n
            ? this.hide()
            : ((e = this.getLabel()),
              this.isHidden && e.attr({ opacity: 1 }).show(),
              this.split
                ? this.renderSplit(n, w(c))
                : (g.style.width ||
                  ...
                  e
                    ...
                    .addClass(
                      "highcharts-color-" + t(f.colorIndex, l.colorIndex)
                    ),
                  e.attr({
        ...
        C(c.slice(0, d.length + 1), function (a, c) {
          if (!1 !== a) {
            ...
            k ||
              (q.tt = k =
                f
                  .label(null, null, null, "callout", null, null, n.useHTML)
                  .addClass("highcharts-tooltip-box " + E)
                  .attr({
                    padding: n.padding,
                    r: n.borderRadius,
            ...
            c.isHeader
              ? ((z = a.height),
                (m = Math.max(
                  0,
                  Math.min(c.plotX + p.plotLeft - m / 2, p.chartWidth - m)
                )))
              : (m = c.plotX + p.plotLeft - t(n.distance, 16) - m);
            0 > m && (b = !1);
            a =
      ...
      getXDateFormat: function (a, d, e) {
        ...
        return (
          (c ? this.getDateFormat(c, a.x, e.options.startOfWeek, d) : d.day) ||
          d.year
        );
      },
      tooltipFooterHeaderFormatter: function (a, d) {
        ...
        b &&
          p &&
          C((a.point && a.point.tooltipDateKeys) || ["key"], function (a) {
    ...
    a.Pointer.prototype = {
      init: function (a, c) {
        ...
        f &&
          ...
          (this.followTouchMove = x(c.tooltip.followTouchMove, !0)));
        this.setDOMEvents();
      },
      ...
      getChartCoordinatesFromPoint: function (a, c) {
        ...
        if (f && b)
          return c
            ? { chartX: f.len + f.pos - d, chartY: b.len + b.pos - a.plotY }
      ...
      runPointActions: function (b, c) {
        var f = this.chart,
          ...
          n = this.getHoverData(
            ...
            n,
            f.series,
            !!c || (n && n.directTouch && this.isDirectTouch),
            e,
            b,
        ...
        if (p && (p !== f.hoverPoint || (d && d.isHidden))) {
          ...
          c &&
            ...
            !d.isHidden &&
            ((p = d.getAnchor([{}], b)),
            d.updatePosition({ plotX: p[0], plotY: p[1] }));
        this.unDocMouseMove ||
      ...
      scaleGroups: function (a, c) {
        ...
        t(b.series, function (d) {
          ...
          d.xAxis &&
            ...
            (d.group.attr(f),
            d.markerGroup &&
              (d.markerGroup.attr(f),
              d.markerGroup.clip(c ? b.clipRect : null)),
            d.dataLabelsGroup && d.dataLabelsGroup.attr(f));
        });
      ...
      drag: function (a) {
        ...
        (G && G.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(h - f, 2) + Math.pow(v - d, 2)
          )),
          10 < this.hasDragged &&
            ((l = b.isInsidePlot(h - g, v - m)),
            ...
            G &&
              e &&
              ((f -= h),
              G.attr({ width: Math.abs(f), x: (0 < f ? 0 : f) + h })),
            G &&
              p &&
              ((f = d - v),
              G.attr({ height: Math.abs(f), y: (0 < f ? 0 : f) + v })),
      ...
      drop: function (a) {
        ...
        f &&
          c(f.index) &&
          (g(f.container, { cursor: f._cursor }),
      ...
      onContainerClick: function (a) {
        ...
        b.cancelClick ||
          (c && this.inClass(a.target, "highcharts-tracker")
            ? (u(c.series, "click", w(a, { point: c })),
              b.hoverPoint && c.firePointEvent("click", a))
            : (w(a, this.getCoordinates(a)),
              b.isInsidePlot(a.chartX - f, a.chartY - d) && u(b, "click", a)));
      },
      setDOMEvents: function () {
        ...
        a.unbindDocumentMouseUp ||
          (a.unbindDocumentMouseUp = C(f, "mouseup", b.onDocumentMouseUp));
        a.hasTouch &&
  ...
  (function (a) {
    ...
    D(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, e, g, r, c, d, k, x) {
        ...
        e < m.min
          ? ((e = m.min), (v = !0))
          : e + q > m.max && ((e = m.max - q), (v = !0));
        v
          ? ((M -= 0.8 * (M - k[f][0])), E || (h -= 0.8 * (h - k[f][1])), g())
          : (k[f] = [M, h]);
        H || ((d[f] = u - t), (d[l] = q));
        d = H ? 1 / B : B;
        c[l] = q;
      ...
      pinch: function (a) {
        var t = this,
          ...
          b =
            1 === d &&
            ((t.inClass(a.target, "highcharts-tracker") && l.runTrackerClick) ||
              t.runChartClick),
          n = {};
        1 < d && (t.initiated = !0);
        ...
        "touchstart" === a.type
          ? (F(c, function (a, b) {
            ...
            (k.x = [u[0].chartX, u[1] && u[1].chartX]),
            (k.y = [u[0].chartY, u[1] && u[1].chartY]),
            F(l.axes, function (a) {
              if (a.zoomEnabled) {
            ...
            (t.res = !0))
          : t.followTouchMove && 1 === d
          ? this.runPointActions(t.normalize(a))
          : u.length &&
            (p ||
              (t.selectionMarker = p = D({ destroy: g, touch: !0 }, l.plotBox)),
            t.pinchTranslate(u, c, f, p, n, k),
            (t.hasPinched = x),
            t.scaleGroups(f, n),
            t.res && ((t.res = !1), this.reset(!1, 0)));
      },
      touch: function (g, r) {
        var l = this.chart,
          t,
        ...
        1 === g.touches.length
          ? ((g = this.normalize(g)),
            (c = l.isInsidePlot(g.chartX - l.plotLeft, g.chartY - l.plotTop)) &&
            !l.openMenu
              ? (r && this.runPointActions(g),
                "touchmove" === g.type &&
                  ((r = this.pinchDown),
                  (t = r[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(r[0].chartX - g.chartX, 2) +
                          Math.pow(r[0].chartY - g.chartY, 2)
                      )
                    : !1)),
                e(t, !0) && this.pinch(g))
              : r && this.reset())
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      colorizeItem: function (a, c) {
        ...
        g &&
          (B &&
            g.isMarker &&
            ((l = a.pointAttribs()), c || (l.stroke = l.fill = p)),
          g.attr(l));
          ...
          g(
            ...
            function (f) {
              var e = f.checkbox,
                g;
              e &&
                ((g = c + d + e.y + (this.scrollOffset || 0) + 3),
                F(e, {
      ...
      setText: function (c) {
        ...
        c.legendItem.attr({
          text: d.labelFormat
            ? a.format(d.labelFormat, c, this.chart.time)
            : d.labelFormatter.call(c),
        });
      },
      renderItem: function (a) {
        ...
        m ||
          ((a.legendGroup = b
            ...
            .addClass(
              "highcharts-" +
                ...
                a.colorIndex +
                (h ? " " + h : "") +
                (E ? " highcharts-series-" + a.index : "")
            )
            .attr({ zIndex: 1 })
            .add(this.scrollGroup)),
          (a.legendItem = m =
            b
              .text("", t ? e + g : -g, this.baseline || 0, G)
              .css(l(a.visible ? q : k))
              .attr({ align: t ? "left" : "right", zIndex: 2 })
              .add(a.legendGroup)),
          this.baseline ||
            ((e = q.fontSize),
            (this.fontMetrics = b.fontMetrics(e, m)),
          ...
          this.setItemEvents && this.setItemEvents(a, m, G),
          x && this.createCheckboxForItem(a));
        this.colorizeItem(a, a.visible);
        q.width ||
          m.css({ width: (d.itemWidth || d.width || c.spacingBox.width) - p });
        this.setText(a);
        c = m.getBBox();
        a.itemWidth = a.checkboxOffset =
          d.itemWidth || a.legendItemWidth || c.width + p;
      ...
      layoutItem: function (a) {
        var c = this.options,
          ...
          c =
            c.alignColumns && this.totalItemWidth > l
              ? this.maxItemWidth
              : a.itemWidth;
        d &&
          this.itemX - b + c > l &&
          ((this.itemX = b),
          (this.itemY += q + this.lastLineHeight + g),
        ...
        d
          ? (this.itemX += c)
          : ((this.itemY += q + e + g), (this.lastLineHeight = e));
        this.offsetWidth =
          p ||
          Math.max(
      ...
      getAllItems: function () {
        ...
        g(this.chart.series, function (c) {
          var b = c && c.options;
          c &&
            u(b.showInLegend, r(b.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(
              ...
              e.test(f) &&
                ...
                (b[w[g]] = Math.max(
                  ...
                  b.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] +
                    ...
                    u(d.margin, 12) +
                    c[g] +
                    (0 === g && void 0 !== b.options.title.margin
      ...
      render: function () {
        ...
        k &&
          ...
          /(lth|ct|rth)/.test(this.getAlignment()) &&
            (c = l(c, { y: c.y + a.titleOffset + a.options.title.margin })),
          b.align(l(B, { width: x, height: q }), !0, c));
      ...
      handleOverflow: function (a) {
        ...
        x.length = 0;
        a > b && !1 !== t.enabled
          ? ((this.clipHeight = p = Math.max(b - 20 - this.titleHeight - q, 0)),
            ...
            l ||
              ((l = c.clipRect = d.clipRect(0, q, 9999, 0)),
              c.contentGroup.clip(l)),
            v(p),
            A ||
              ((this.nav = A = d.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = d
                .symbol("triangle", 0, 0, E, E)
                .on("click", function () {
                  c.scroll(-1, m);
                })
                .add(A)),
      ...
      scroll: function (a, d) {
        ...
        0 < a &&
          ...
          this.down
            .attr({ fill: a === f ? g.inactiveColor : g.activeColor })
    ...
    a.LegendSymbolMixin = {
      ...
      drawLineMarker: function (a) {
        ...
        b &&
          !1 !== b.enabled &&
          ((c = Math.min(u(b.radius, g), g)),
          0 === this.symbol.indexOf("url") &&
            ((b = l(b, { width: e, height: e })), (c = 0)),
          (this.legendSymbol = b =
            k
    ...
    (/Trident\/7\.0/.test(k.navigator.userAgent) || t) &&
      x(a.Legend.prototype, "positionItem", function (a, c) {
        var b = this,
          d = function () {
    ...
    x(P.prototype, {
      ...
      redraw: function (b) {
        ...
        k(d, function (a) {
          a.isDirty &&
            ...
            (a.updateTotals && a.updateTotals(), (e = !0));
        ...
        k(
          ...
          function (a) {
            ...
            c &&
              ...
              c
                .css({ width: (h.width || f.width + h.widthAdjust) + "px" })
                .align(x({ y: a + m }, h), !1, "spacingBox"),
              h.floating ||
                h.verticalAlign ||
        ...
        if (b)
          for (; c && c.style; )
            c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle),
              c.hcOrigDetached &&
                (g.body.removeChild(c), (c.hcOrigDetached = !1)),
              (c = c.parentNode);
        else
          for (; c && c.style; ) {
            g.body.contains(c) ||
              c.parentNode ||
              ((c.hcOrigDetached = !0), g.body.appendChild(c));
      ...
      setReflow: function (a) {
        ...
        !1 === a || this.unbindReflow
          ...
          : ((this.unbindReflow = C(Q, "resize", function (a) {
              b.reflow(a);
            })),
      ...
      setSize: function (b, d, h) {
        ...
        (b ? F : c)(
          m.container,
          { width: m.chartWidth + "px", height: m.chartHeight + "px" },
          b
        );
        m.setChartSize(!0);
      ...
      setChartSize: function (a) {
        ...
        this.plotHeight = E = Math.max(
          0,
          Math.round(h - q - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(d, g[2]) / 2 - c)
          ),
        };
        a ||
      ...
      drawChartBox: function () {
        ...
        p &&
          (A
            ? A.animate(B)
            : (this.plotBGImage = b.image(p, v, n, l, G).add()));
        x
          ? x.animate({ width: t.width, height: t.height })
  ...
  (function (a) {
              ...
              D(this.axes, function (e) {
                1 === e.side
                  ? (e.getPlotLinePath = function () {
                      ...
                      r = a.Axis.prototype.getPlotLinePath.apply(
                        this,
                        arguments
                      );
                      this.right = g;
    ...
    F.prototype.applyFixed = function () {
      ...
      this.fixedDiv ||
        ...
        (this.fixedRenderer = g = new a.Renderer(this.fixedDiv, 0, 0)),
  ...
  (function (a) {
    ...
    a.Point.prototype = {
      ...
      applyOptions: function (a, d) {
        ...
        void 0 === this.x &&
          c &&
          (this.x = void 0 === d ? c.autoIncrement(this) : d);
        return this;
      },
      ...
      optionsToObject: function (c) {
        ...
        if (w(c) || null === c) d[p[0]] = c;
          ...
          for (
            ...
            c.length > f &&
            ((e = typeof c[0]),
            "string" === e ? (d.name = c[0]) : "number" === e && (d.x = c[0]),
            b++);
            n < f;
            ...
            (g && void 0 === c[b]) ||
              (0 < p[n].indexOf(".")
                ? a.Point.prototype.setNestedProperty(d, c[b], p[n])
                : (d[p[n]] = c[b])),
              b++,
              n++;
        else
          "object" === typeof c &&
            ((d = c),
            c.dataLabels && (e._hasPointLabels = !0),
            c.marker && (e._hasPointMarkers = !0));
        return d;
      },
      ...
      },
      {
        ...
        autoIncrement: function () {
          ...
          d &&
            ((a = new f.Date(b)),
            "day" === d
              ? f.set("Date", a, f.get("Date", a) + c)
              : "month" === d
              ? f.set("Month", a, f.get("Month", a) + c)
              : "year" === d && f.set("FullYear", a, f.get("FullYear", a) + c),
            (c = a.getTime() - b));
          this.xIncrement = b + c;
          return b;
        },
        ...
        updateData: function (b) {
          ...
          l(
            ...
            function (b) {
              ...
              p(h) &&
                ((h = a.inArray(h, this.xData, m)),
                -1 === h
                  ? f.push(b)
                  : b !== c.data[h]
                  ? (d[h].update(b, !1, null, !1),
                    (d[h].touched = !0),
                    g && (m = h))
                  : d[h] && (d[h].touched = !0),
                (e = !0));
          ...
          if (!H) {
            ...
            if (B && q > B) {
              ...
              for (d = 0; d < q; d++)
                void 0 !== b[d] &&
                  ((n = { series: m }),
                  m.pointClass.prototype.applyOptions.apply(n, [b[d]]),
                  m.updateParallelArrays(n, d));
        ...
        processData: function (b) {
          ...
          if (n && this.sorted && !p && (!q || f > q || this.forceCrop))
            if (c[f - 1] < t || c[0] > r) (c = []), (d = []);
              ...
              (e = this.cropData(this.xData, this.yData, t, r)),
                (c = e.xData),
                (d = e.yData),
                (e = e.start),
                (h = !0);
          for (q = c.length || 1; --q; )
            (f = l ? k(c[q]) - k(c[q - 1]) : c[q] - c[q - 1]),
              0 < f && (void 0 === m || f < m)
                ? (m = f)
                : 0 > f && B && (a.error(15), (B = !1));
          this.cropped = h;
          this.cropStart = e;
        ...
        generatePoints: function () {
          ...
          for (t = 0; t < g; t++)
            (p = k + t),
              n
                ? ((l = new e().init(this, [f[t]].concat(q(h[t])))),
                  (l.dataGroup = this.groupMap[t]))
                : (l = c[p]) ||
                  void 0 === b[p] ||
                  (c[p] = l = new e().init(this, b[p], f[t])),
              l && ((l.index = p), (B[t] = l));
          this.options.keys = a;
          if (c && (g !== (d = c.length) || n))
            for (t = 0; t < d; t++)
        ...
        translate: function () {
          ...
          for (a = 0; a < q; a++) {
            ...
            var F =
                b &&
                e.stacks[
                  (this.negStacks && D < (B ? 0 : t) ? "-" : "") + this.stackKey
                ],
              K;
            ...
            L.plotX = r = g(
              Math.min(
                Math.max(
                  -1e5,
                  c.translate(C, 0, 0, 0, 1, n, "flags" === this.type)
                ),
                1e5
              )
            );
        ...
        setClip: function (a) {
          ...
          !1 !== c.clip &&
            (this.group.clip(a || h ? g : b.clipRect),
          ...
          if (!1 !== e.enabled || this._hasPointMarkers)
            for (c = 0; c < a.length; c++)
              (d = a[c]),
                ...
                (k = d.isInside),
                f && !d.isNull
                  ? ((f = z(g.symbol, this.symbol)),
                    (n = this.markerAttribs(d, d.selected && "select")),
                    h
                      ? h[k ? "show" : "hide"](!0).animate(n)
                      : k &&
                        (0 < n.width || d.hasImage) &&
                        (d.graphic = h =
                          b.renderer
                            .symbol(f, n.x, n.y, n.width, n.height, q ? g : e)
                            .add(p)),
                    h && h.attr(this.pointAttribs(d, d.selected && "select")),
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (d = z(
              b.lineWidth,
              c.lineWidth,
              d + z(b.lineWidthPlus, c.lineWidthPlus, 0)
            )),
        ...
        destroy: function () {
          ...
          l(b.axisTypes || [], function (a) {
            (k = b[a]) &&
              k.series &&
              (u(k.series, b), (k.isDirty = k.forceRedraw = !0));
          });
          ...
          l(d, function (d, f) {
            ...
            h
              ...
              : c.length &&
                ...
                (h = a[e].attr(h).shadow(2 > f && b.shadow)));
        ...
        applyZones: function () {
          ...
          d.length &&
            ...
            l(d, function (d, h) {
              ...
              e = Math.min(
                Math.max(Math.round(t.toPixels(z(d.value, B.max), !0)), 0),
                p
              );
              ...
              L = Math.max(f, e);
              t.isXAxis
                ? ((q = { x: x ? L : w, y: 0, width: H, height: p }),
                  u || (q.x = b.plotHeight - q.x))
                : ((q = { x: 0, y: x ? L : w, width: p, height: H }),
                  u && (q.y = b.plotWidth - q.y));
              x &&
                c.isVML &&
                (q = t.isXAxis
                  ? { x: 0, y: r ? w : L, height: q.width, width: b.chartWidth }
                  : {
              ...
              g[h]
                ? g[h].animate(q)
                : ((g[h] = c.clipRect(q)),
                  k && a["zone-graph-" + h].clip(g[h]),
                  n && a["zone-area-" + h].clip(g[h]));
              J = d.value > B.max;
      ...
      setOffset: function (a, d) {
        ...
        if ((d = this.label))
          d.align(this.alignOptions, null, c),
            (c = d.alignAttr),
            d[
              !1 === this.options.crop || e.isInsidePlot(c.x, c.y)
                ? "show"
                : "hide"
            ](!0);
      },
    ...
    F.prototype.getStacks = function () {
      ...
      e(a.series, function (c) {
        !c.options.stacking ||
          ...
          (c.stackKey = c.type + l(c.options.stack, ""));
      });
    };
      ...
      if (
        ...
        for (G = 0; G < g; G++)
          (h = c[G]),
            ...
            B[A][h] ||
              (H[A] && H[A][h]
                ? ((B[A][h] = H[A][h]), (B[A][h].total = null))
                : (B[A][h] = new a.StackItem(
                    w,
            ...
            (A = B[A][h]),
            null !== v
              ? ((A.points[M] = A.points[this.index] = [l(A.cumulative, b)]),
                r(A.cumulative) || (A.base = M),
                (A.touched = w.stacksTouched),
                0 < m.index &&
                  !1 === this.singleStacks &&
                  (A.points[M][0] = A.points[this.index + "," + h + ",0"][0]))
              : (A.points[M] = A.points[this.index] = null),
            "percent" === p
              ? ((E = E ? t : u),
                q && B[E] && B[E][h]
                  ? ((E = B[E][h]),
                    (A.total = E.total =
                      Math.max(E.total, A.total) + Math.abs(v) || 0))
                  : (A.total = D(A.total + (Math.abs(v) || 0))))
              : (A.total = D(A.total + (v || 0))),
            (A.cumulative = l(A.cumulative, b) + (v || 0)),
            null !== v &&
              (A.points[M].push(A.cumulative), (e[G] = A.cumulative));
      ...
      a[f + "Stacker"] &&
        e([d, "-" + d], function (b) {
          for (var c = l.length, d, e; c--; )
            if (
              ((d = l[c]),
              (p = a.getStackIndicator(p, d, a.index, b)),
              (e = (d = g[b] && g[b][d]) && d.points[p.key]))
            )
              a[f + "Stacker"](e, d, c);
        });
    };
  ...
  (function (a) {
    ...
    l(a.Chart.prototype, {
      ...
      update: function (a, g, m, q) {
        ...
        t("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
          a[b] &&
            (t(L(a[b]), function (a, c) {
              (c = (e(a.id) && k.get(a.id)) || k[b][c]) &&
                c.coll === b &&
                (c.update(a, !1), m && (c.touched = !0));
              if (!c && m)
        ...
        v &&
          t(k.series, function (a) {
            a.update({}, !1);
          });
        a.loading && p(!0, k.options.loading, a.loading);
        h = l && l.width;
        l = l && l.height;
        (d(h) && h !== k.chartWidth) || (d(l) && l !== k.chartHeight)
          ? k.setSize(h, l, q)
          : b(g, !0) && k.redraw(q);
      },
    ...
    l(n.prototype, {
      update: function (a, c, d, f) {
        function e() {
          ...
          p.data[m] =
            k(p.data[m], !0) || k(a, !0) ? g.options : b(a, p.data[m]);
    ...
    l(z.prototype, {
      addPoint: function (a, c, d, f) {
        ...
        d &&
          (g[0] && g[0].remove
            ? g[0].remove(!1)
            : (g.shift(), this.updateParallelArrays(k, "shift"), m.shift()));
      ...
      update: function (d, f) {
        var e = this,
          ...
          z = e.finimhedAnimating && { animation: !1 },
        ...
        if (y)
          ...
          d = p(
            q,
            z,
            { index: e.index, pointStart: b(q.pointStart, e.xData[0]) },
            { data: e.options.data },
            d
          );
          e.remove(!1, null, !1);
    ...
    l(D.prototype, {
      ...
      remove: function (a) {
        for (
          var c = this.chart, d = this.coll, f = this.series, e = f.length;
          e--;
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getGraphPath: function (a) {
          var e = g.prototype.getGraphPath,
            ...
            L = function (d, e, g) {
              ...
              var m,
                ...
                q = !0;
              g || k
                ? ((m = (k ? d[0] : d[1]) + g), (l = d[0] + g), (q = !!k))
                : !t && a[e] && a[e].isNull && (m = l = z);
              void 0 !== m &&
                (p.push({
                  plotX: b,
          ...
          for (d = 0; d < a.length; d++)
            if (
              ((k = a[d].isNull),
              (b = r(a[d].rectPlotX, a[d].plotX)),
              (q = r(a[d].yBottom, J)),
              !k || l)
            )
              l || L(d, d - 1, "left"),
                (k && !t && l) ||
                  (p.push(a[d]), x.push({ x: d, plotX: b, plotY: q })),
                l || L(d, d + 1, "right");
          d = e.call(this, p, !0, !0);
          x.reversed = !0;
          k = e.call(this, x, !0, !0);
        ...
        drawGraph: function () {
          ...
          F(u, function (c) {
            var d = c[0],
              g = a[d];
            g
              ? ((g.endX = a.preventGraphAnimation ? null : e.xMap),
                g.animate({ d: e }))
              : ((g = a[d] =
                  a.chart.renderer
                    .path(e)
                    ...
                    .attr({
                      fill: r(
                        c[3],
                        C(c[2]).setOpacity(r(l.fillOpacity, 0.75)).get()
                      ),
                      zIndex: 0,
                    })
                    .add(a.group)),
      ...
      {},
      {
        getPointSpline: function (a, D, r) {
          ...
          if (
            ...
            c += d;
            l > a && l > e
              ? ((l = Math.max(a, e)), (c = 2 * e - l))
              : l < a && l < e && ((l = Math.min(a, e)), (c = 2 * e - l));
            c > r && c > e
              ? ((c = Math.max(r, e)), (l = 2 * e - c))
              : c < r && c < e && ((c = Math.min(r, e)), (l = 2 * e - c));
            D.rightContX = u;
            D.rightContY = c;
          }
          D = [
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          var l = Math.min(
            ...
            d = Math.min(
              ...
              t(d.pointWidth, q * (1 - 2 * d.pointPadding))
            );
          a.columnMetrics = {
            width: d,
            offset:
              (q - d) / 2 +
              (r + ((a.columnIndex || 0) + (p ? 1 : 0)) * q - l / 2) *
                (p ? -1 : 1),
          };
        ...
        translate: function () {
          ...
          D(a.points, function (c) {
            ...
            n &&
              Math.abs(h) < n &&
              ((h = n),
              (B = (!p.reversed && !c.negative) || (p.reversed && c.negative)),
              c.y === f && a.dataMax <= f && p.min < f && (B = !B),
              (x = Math.abs(x - b) > n ? e - n : b - (B ? n : 0)));
            c.barX = k;
            c.pointWidth = r;
            c.tooltipPos = d.inverted
              ? [p.len + p.pos - d.plotLeft - g, a.xAxis.len - k - l / 2, h]
              : [k + l / 2, g + p.pos - d.plotTop, h];
            c.shapeType = "rect";
            c.shapeArgs = a.crispCol.apply(
              a,
              c.isNull ? [k, b, l, 0] : [k, x, l, h]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function (a, d) {
          ...
          d &&
            ...
            (b =
              a.color ||
              (void 0 !== d && F(b).brighten(a.brightness).get()) ||
              b),
            (n = a[g] || n),
            (l = a[f] || l),
            (p = a.dashStyle || p));
        ...
        drawPoints: function () {
          ...
          D(a.points, function (b) {
            ...
            if (g(b.plotY) && null !== b.y) {
              ...
              c[t](a.pointAttribs(b, b.selected && "select")).shadow(
                k.shadow,
                null,
          ...
          u &&
            (a
              ? ((f.scaleY = 0.001),
                (a = Math.min(
                  e.pos + e.len,
                  Math.max(e.pos, e.toPixels(g.threshold))
                )),
                p ? (f.translateX = a - e.len) : (f.translateY = a),
                c.group.attr(f))
              : ((n = c.group.attr(b)),
                c.group.animate(
                  { scaleY: 1 },
      ...
      },
      {
          ...
          a ||
            (r(d, function (a) {
              var d = a.graphic,
                f = a.shapeArgs;
              d &&
                (d.attr({ r: a.startR || c.center[3] / 2, start: b, end: b }),
                d.animate(
        ...
        translate: function (a) {
          ...
          this.getX = function (b, c, d) {
            ...
            return (
              a[0] + (c ? -1 : 1) * Math.cos(q) * (a[2] / 2 + d.labelDistance)
            );
          };
          for (A = 0; A < C; A++) {
            G = w[A];
            ...
            t = (Math.cos(q) * a[2]) / 2;
            m = (Math.sin(q) * a[2]) / 2;
            G.tooltipPos = [a[0] + 0.7 * t, a[1] + 0.7 * m];
            G.half = q < -Math.PI / 2 || q > Math.PI / 2 ? 1 : 0;
            G.angle = q;
            k = Math.min(g, G.labelDistance / 5);
            G.labelPos = [
              a[0] + t + Math.cos(q) * G.labelDistance,
              a[1] + m + Math.sin(q) * G.labelDistance,
              a[0] + t + Math.cos(q) * k,
              a[1] + m + Math.sin(q) * k,
              a[0] + t,
              a[1] + m,
        ...
        drawPoints: function () {
          ...
          r(a.points, function (f) {
            ...
            if (f.isNull) b && (f.graphic = b.destroy());
              ...
              b
                ? b.setRadialReference(a.center).attr(e).animate(g(k, d))
                : ((f.graphic = b =
                    c[f.shapeType](k)
                      .setRadialReference(a.center)
                      .attr(d)
                      .add(a.group)),
                  f.visible || b.attr({ visibility: "hidden" }),
      ...
      },
      {
        ...
        setVisible: function (a, c) {
          ...
          a !== d.visible &&
            ...
            (b.options.data[t(d, b.data)] = d.options),
            r(
  ...
  (function (a) {
    ...
    a.distribute = function (c, b, d) {
      ...
      for (
        ...
        for (g = !1; f--; )
          0 < f &&
            c[f - 1].pos + c[f - 1].size > c[f].pos &&
            ((c[f - 1].size += c[f].size),
            (c[f - 1].targets = c[f - 1].targets.concat(c[f].targets)),
            (c[f - 1].align = 0.5),
            c[f - 1].pos + c[f - 1].size > b &&
              (c[f - 1].pos = b - c[f - 1].size),
            c.splice(f, 1),
            (g = !0));
      }
      k.push.apply(k, l);
      ...
      x(c, function (c) {
        var e = 0;
        if (
          x(c.targets, function () {
            k[f].pos = c.pos + e;
            if (Math.abs(k[f].pos - k[f].target) > d)
              return (
                r(k.slice(0, f + 1), function (a) {
                  delete a.pos;
                }),
                (k.reducedLen = (k.reducedLen || b) - 0.1 * b),
                k.reducedLen > 0.1 * b && a.distribute(k, b, d),
                !0
              );
            e += k[f].size;
            f++;
    ...
    d.prototype.drawDataLabels = function () {
      ...
      if (k.enabled || b._hasPointLabels)
        b.dlProcessOptions && b.dlProcessOptions(k),
          (x = b.plotGroup(
            "dataLabelsGroup",
            "data-labels",
            A && !t ? "hidden" : "visible",
          ...
          r(q, function (f) {
            ...
            (h = u(l && l.enabled, p.enabled) && !f.isNull) &&
              (h = !0 === c(f, l || k));
            h &&
              ((k = w(p, l)),
              (n = f.getLabelConfig()),
              (z = k[f.formatPrefix + "Format"] || k.format),
              (m = D(z)
                ? e(z, n, d.time)
                : (k[f.formatPrefix + "Formatter"] || k.formatter).call(n, k)),
              (z = k.style),
              (n = k.rotation),
              (z.color = u(k.color, z.color, b.color, "#000000")),
              "contrast" === z.color &&
                ((f.contrastColor = F.getContrast(f.color || b.color)),
                (z.color =
                  k.inside || 0 > u(f.labelDistance, k.distance) || g.stacking
                    ? f.contrastColor
                    : "#000000")),
            ...
            !q || (h && D(m))
              ? h &&
                ...
                (q
                  ...
                  : ((q = f.dataLabel =
                      n
                        ? F.text(m, 0, -9999).addClass("highcharts-data-label")
                        : F.label(
                            m,
                            0,
                            -9999,
                    ...
                    q.addClass(
                      " highcharts-data-label-color-" +
                        ...
                        " " +
                        (k.className || "") +
                        (k.useHTML ? "highcharts-tracker" : "")
                    )),
                q.attr(t),
                q.css(z).shadow(k.shadow),
                q.added || q.add(x),
                b.alignDataLabel(f, q, k, null, B))
              : ((f.dataLabel = q = q.destroy()),
    ...
    d.prototype.alignDataLabel = function (a, b, c, d, e) {
      var f = this.chart,
        ...
        w =
          this.visible &&
          (a.series.forceDL ||
            f.isInsidePlot(l, Math.round(n), k) ||
            (d && f.isInsidePlot(l, k ? d.x + 1 : d.y + d.height - 1, k))),
        h = "justify" === u(c.overflow, "justify");
      if (
        w &&
        ((p = c.style.fontSize),
        (p = f.renderer.fontMetrics(p, b).b),
        (d = g(
          {
        ...
        g(c, { width: m.width, height: m.height }),
        t
          ? ((h = !1),
            (l = f.renderer.rotCorr(p, t)),
            (l = {
            ...
            b[e ? "attr" : "animate"](l).attr({ align: r }),
            (n = (t + 720) % 360),
            (n = 180 < n && 360 > n),
            "left" === r
              ? (l.y -= n ? m.height : 0)
              : "center" === r
              ? ((l.x -= m.width / 2), (l.y -= m.height / 2))
              : "right" === r && ((l.x -= m.width), (l.y -= n ? 0 : m.height)),
            (b.placed = !0),
            (b.alignAttr = l))
          : (b.align(c, null, d), (l = b.alignAttr)),
        h
          ? (a.isLabelJustified = this.justifyDataLabel(b, c, l, m, d, e))
          : u(c.crop, !0) &&
            (w =
              f.isInsidePlot(l.x, l.y) &&
              f.isInsidePlot(l.x + m.width, l.y + m.height)),
        c.shape && !t)
      )
        b[e ? "attr" : "animate"]({
    ...
    d.prototype.justifyDataLabel = function (a, b, c, d, e, g) {
      ...
      m = c.x + d.width - n;
      m > f.plotWidth &&
        ("left" === q ? (b.align = "right") : (b.x = f.plotWidth - m),
        (l = !0));
      m = c.y + n;
      0 > m &&
        ("bottom" === k ? (b.verticalAlign = "top") : (b.y = -m), (l = !0));
      m = c.y + d.height - n;
      m > f.plotHeight &&
        ("top" === k ? (b.verticalAlign = "bottom") : (b.y = f.plotHeight - m),
        (l = !0));
    ...
    k.pie &&
      ((k.pie.prototype.drawDataLabels = function () {
        ...
        c.visible &&
          ...
          d.prototype.drawDataLabels.apply(c),
          r(b, function (a) {
            a.dataLabel &&
              a.visible &&
              (I[a.half].push(a),
              ...
              for (
                c.sortByAngle(b, d - 0.5),
                  0 < c.maxLabelDistance &&
                    ((f = Math.max(0, G - C - c.maxLabelDistance)),
                    (m = Math.min(G + C + c.maxLabelDistance, g.plotHeight)),
                    r(b, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, G - C - a.labelDistance)),
                        (a.bottom = Math.min(
                          G + C + a.labelDistance,
                          g.plotHeight
                        )),
                ...
                (e = b[R]),
                  ...
                  n &&
                    ...
                    (void 0 === n[m].pos
                      ? (y = "hidden")
                      : ((P = n[m].size), (N = e.top + n[m].pos))),
                  delete e.positionIndex,
                  (O = k.justify
                    ? x[0] + (d ? -1 : 1) * (C + e.labelDistance)
                    : c.getX(N < e.top + 2 || N > e.bottom - 2 ? f : N, d, e)),
                  (h._attr = { visibility: y, align: K[6] }),
                  (h._pos = {
                  ...
                  u(k.crop, !0) &&
                    ...
                    O - v < q && 1 === d
                      ...
                      : O + v > p - q &&
                        0 === d &&
                        ((f = Math.round(O + v - p + q)),
                        (S[1] = Math.max(f, S[1]))),
                    0 > N - P / 2
                      ? (S[0] = Math.max(Math.round(-N + P / 2), S[0]))
                      : N + P / 2 > t &&
                        (S[2] = Math.max(Math.round(N + P / 2 - t), S[2])),
                    (h.sideOverflow = f));
          }),
          0 === F(S) || this.verifyDataLabelOverflow(S)) &&
      ...
      (k.pie.prototype.alignDataLabel = l),
      (k.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        k ||
          (null !== e[0]
            ...
            : ((g = Math.max(b[2] - a[1] - a[3], f)),
              (b[0] += (a[3] - a[1]) / 2)),
          null !== e[1]
            ? (g = Math.max(Math.min(g, b[2] - Math.max(a[0], a[2])), f))
            : ((g = Math.max(Math.min(g, b[2] - a[0] - a[2]), f)),
              (b[1] += (a[0] - a[2]) / 2)),
          g < b[2]
            ? ((b[2] = g),
              (b[3] = Math.min(c(d.innerSize || 0, g), g)),
              this.translate(b),
    ...
    k.column &&
      (k.column.prototype.alignDataLabel = function (a, b, c, e, g) {
        ...
        l &&
          ...
          m ||
            (f
              ? ((e.x += p ? 0 : e.width), (e.width = 0))
              : ((e.y += p ? e.height : 0), (e.height = 0))));
        c.align = u(c.align, !f || m ? "center" : p ? "right" : "left");
        c.verticalAlign = u(
          c.verticalAlign,
          f || m ? "middle" : p ? "top" : "bottom"
        );
      ...
      for (r = 0; r < e; r++)
        if ((g = a[r]))
          (g.oldOpacity = g.opacity),
            (g.newOpacity = 1),
            g.width ||
              ((l = g.getBBox()), (g.width = l.width), (g.height = l.height));
      a.sort(function (a, c) {
  ...
  (function (a) {
    ...
    J = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var a = this,
          ...
          w = "rgba(192,192,192," + (z ? 0.0001 : 0.002) + ")";
        if (e && !c)
          for (n = e + 1; n--; )
            "M" === d[n] && d.splice(n + 1, 0, d[n + 1] - p, d[n + 2], "L"),
              ((n && "M" === d[n]) || n === e) &&
                d.splice(n, 0, "L", d[n - 2] + p, d[n - 1]);
        h
          ? h.attr({ d: d })
          : a.graph &&
            ((a.tracker = k
    ...
    w(F.prototype, {
      ...
      zoom: function (a) {
        ...
        e && !f
          ? this.showResetZoom()
          : !e && d(f) && (this.resetZoomButton = f.destroy());
        b &&
          this.redraw(
            p(
      ...
      pan: function (a, b) {
        ...
        t("xy" === b ? [1, 0] : [1], function (b) {
          ...
          var d = b.horiz,
            ...
            k = Math.min(
              l.dataMin,
              h ? l.min : b.toValue(b.toPixels(l.min) - b.minPixelPadding)
            ),
            h = Math.max(
              l.dataMax,
              h ? l.max : b.toValue(b.toPixels(l.max) + b.minPixelPadding)
            ),
            q = k - g;
          0 < q && ((m += q), (g = k));
          q = m - h;
      ...
      setState: function (a, b) {
        ...
        if (
          !(
            ...
            !1 === g.enabled ||
            (a && (h || (q && !1 === n.enabled))) ||
            (a && t.states && t.states[a] && !1 === t.states[a].enabled)
          )
        ) {
          ...
          if (this.graphic)
            this.state &&
              ...
              this.graphic.animate(
                ...
                p(u.options.chart.animation, g.animation)
              ),
              z &&
                this.graphic.animate(
                  z,
                  p(u.options.chart.animation, n.animation, k.animation)
                ),
              r && r.hide();
          else {
            if (a && n) {
            ...
            r &&
              (r[a && u.isInsidePlot(c, d, u.inverted) ? "show" : "hide"](),
              (r.element.point = this));
          }
          (c = g.halo) && c.size
            ? (x ||
                (f.halo = x =
                  u.renderer.path().add((this.graphic || r).parentGroup)),
              x.show()[b ? "animate" : "attr"]({ d: this.haloPath(c.size) }),
              x.attr({
                class:
                  "highcharts-halo highcharts-color-" +
                  p(this.colorIndex, f.colorIndex) +
  ...
  (function (a) {
    ...
    C.prototype.matchResponsiveRule = function (a, g) {
      ...
      (
        ...
        function () {
          return (
            this.chartWidth <= e(l.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= e(l.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= e(l.minWidth, 0) &&
            this.chartHeight >= e(l.minHeight, 0)
          );
        }
