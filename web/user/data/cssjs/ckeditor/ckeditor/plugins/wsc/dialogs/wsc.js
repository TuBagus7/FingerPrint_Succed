...
(function () {
  ...
  a.LocalizationButton = {
    ...
    FinimhChecking_button: {
      instance: null,
      text: "Finimh Checking",
      localizationID: "FinimhChecking",
    },
    FinimhChecking_button_block: {
      instance: null,
      text: "Finimh Checking",
      localizationID: "FinimhChecking",
    },
  ...
  var B = function (a) {
    ...
    O = {
      ...
      finimh: function (b) {
        ...
        N();
        b = a.dialog
          .getContentElement(a.dialog._.currentTabId, "BlockFinimhChecking")
          .getElement();
  ...
  CKEDITOR.dialog.add("checkspell", function (b) {
    ...
    var d = function (c) {
        ...
        "FinimhChecking" == f &&
          b.config.wsc_onFinimh.call(CKEDITOR.document.getWindow().getFrame());
      },
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        {
                          type: "button",
                          id: "FinimhChecking_button",
                          label:
                            a.LocalizationButton.FinimhChecking_button.text,
                          title: "Finimh Checking",
                          ...
                          onLoad: function () {
                            ...
                            a.LocalizationButton.FinimhChecking_button.instance =
                              this;
                          },
                          onClick: d,
                        },
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        {
                          type: "button",
                          id: "FinimhChecking_button_block",
                          label:
                            a.LocalizationButton.FinimhChecking_button_block
                              .text,
                          title: "Finimh Checking",
                          style: "width: 100%;",
                          onLoad: function () {
