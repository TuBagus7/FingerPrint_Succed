...
CKEDITOR.plugins.setLang("a11yhelp", "it", {
  ...
  legend: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          legend:
            "Premere ${elementsPathFocus} per passare agli elementi della barra del percorso. Usare TAB o FRECCIA DESTRA per passare al pulsante successivo. Per passare al pulsante precedente premere MAIUSC+TAB o FRECCIA SInimTRA. Premere SPAZIO o INVIO per selezionare l'elemento nell'editor.",
        },
      ],
    },
    {
  ...
  pageUp: "Pagina sù",
  pageDown: "Pagina giù",
  leftArrow: "Freccia sinimtra",
  upArrow: "Freccia su",
  rightArrow: "Freccia destra",
  downArrow: "Freccia giù",
  insert: "Ins",
  leftWindowKey: "Tasto di Windows sinimtro",
