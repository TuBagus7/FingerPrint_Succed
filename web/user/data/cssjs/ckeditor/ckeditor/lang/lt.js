...
CKEDITOR.lang["lt"] = {
  ...
  common: {
    ...
    imageButton: "Vaizdinim mygtukas",
    ...
    targetTop: "Viršutinim langas (_top)",
    targetSelf: "Esamas langas (_self)",
    targetParent: "Paskutinim langas (_parent)",
    langDirLTR: "Iš kairės į dešinę (LTR)",
    langDirRTL: "Iš dešinės į kairę (RTL)",
    styles: "Stilius",
  ...
  basicstyles: {
    ...
    italic: "Kursyvas",
    strike: "Perbrauktas",
    subscript: "Apatinim indeksas",
    superscript: "Viršutinim indeksas",
  ...
  format: {
    ...
    tag_h1: "Antraštinim 1",
    tag_h2: "Antraštinim 2",
    tag_h3: "Antraštinim 3",
    tag_h4: "Antraštinim 4",
    tag_h5: "Antraštinim 5",
    tag_h6: "Antraštinim 6",
    tag_p: "Normalus",
    tag_pre: "Formuotas",
  },
  ...
  table: {
    ...
    invalidCols: "Skaičius turi būti didesnim nei 0.",
    invalidHeight: "Reikšmė turi būti nurodyta skaičiumi.",
    invalidRows: "Skaičius turi būti didesnim nei 0.",
