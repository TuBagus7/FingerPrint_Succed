...
formula must start with `=` to make PhpSpreadsheet recognime this as a
formula.
...
column invisible, otherwise the collapse will not be visible in Excel 2007.
...
> This invoice is **_payable within thirty days after the end of the
> month_** unless specified otherwise on the invoice.
